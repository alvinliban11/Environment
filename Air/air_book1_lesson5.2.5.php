...
<p>The general procedure to follow in sizing a plate column is as follows:

</p>

<p>1. Calculate the number of theoretical stages N using Figure 5.7 or Equation
(5.15).</p>
<img src="img/yx16.png">


<p>2. Estimate the efficiency of separation E. This may be determined at the local
(across plate), plate (between plates), or overall (across column) level. The
overall efficiency E0 is generally employed.<br>
3. Calculate the actual number of plates:</p>

<img src="img/yx17.png">
<p>4. Obtain the height between plates h. This is usually in the 12–36 inch range.
Most towers use a 24-inch plate spacing.<br>
5. The tower height Z is then</p>
<img src="img/yx18.png">

<p>6. The diameter may be calculated directly from Equation (5.14).<br>
7. The plate or overall pressure drop is difficult to quantify. It is usually in the
2–6-inch H2O per plate range for most columns with the lower and upper
values applying to small and large diameters, respectively. This pressure
drop value represents the approximate height of the liquid on the plates.
</p>

<h4>Strippers</h4>

<p >Absorbers are also used for stripping to regenerate the liquid. During this operation, the
pollutant (absorbate) is transferred from the liquid to the gas (the stripping medium). The
calculations essentially remain the same for both packed and plate towers, except
the height of a packed tower is given by
</p>

<img src="img/yx19.png">
...
<div class="container">
   <a href="air_book1_lesson5.2.4.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson5.2.6.php" class="btn btn-primary">CONTINUE</a>
</div>
