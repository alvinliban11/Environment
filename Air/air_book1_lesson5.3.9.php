...
<p><b>5.30 Spray Efficiency Calculation


</b></p>

<p>A steel pickling operation is “stuck” with a scrubber designed by Dr. Theodore.
The spray tower is currently unable to meet the HCl emission limit of 25ppm.
You are requested to determine under what individual spray efficiency parameter
this design would comply with the limit, given an inlet concentration of
500 ppm.</p>
<p>Solution: This involves a trial-and-error calculation. The required NOG value is</p>

<img src="img/aw21.png">




<p>Calculations for 90% and 80% of each individual spray efficiencies are provided
below, based on the usual 70% efficiency for the top spray:</p>
<img src="img/aw22.png">

<p><b>5.31 Packing Height
</b></p>

<p>Doyle Unlimited, a Daniel F. Rodenci Corporation, has submitted design plans to
Theodore Consultants for a packed ammonia scrubber on an air stream containing NH3. The operating and design data provided by Doyle Unlimited, Inc. are
given below. Theodore Consultants remember reviewing plans for a nearly identical scrubber for Doyle Unlimited, Inc. in 2005. After consulting old files, the
consultants find all the conditions were identical except for the gas flow rate.
What recommendation should be made?
</p>

<p>Tower diameter = 3.57 ft<br>
Packed height of column = 8 ft<br>
Gas and liquid temperature = 758F inlet<br>
Operating pressure = 1.0 atm<br>
Ammonia-free liquid flow rate (mass flux or mass velocity) = 1000<br>
lb/(ft2 . hr)<br>
Gas flow rate = 1575 acfm<br>
Inlet NH3 gas concentration = 2.0 mol%<br>
Air density = 0.0743 lb/ft3<br>
Molecular weight of air = 29<br>
Molecular weight of water = 18<br>
Henry’s law constant m = 0.972<br>
Figure 5.11; packing type A is used<br>
Colburn chart (Figure 5.12) applies<br>
Emission regulation = 0.1% NH3 (by mole or volume)<br>
Packing height = HOGNOG<br>
Solution: Calculate the cross-sectional area of the tower S (note that S is now
employed for the area) in ft2
:</p>




<img src="img/aw23.png"><br>
<img src="img/aw24.png">
...
<div class="container">
   <a href="air_book1_lesson5.3.8.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson5.3.10.php" class="btn btn-primary">CONTINUE</a>
</div>
