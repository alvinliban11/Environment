...
<p class="indent">5. Equation (4.5) depicts the amount of heat required to raise a set quantity of gas
from T1 to T2. Of more importance is the heat rate Q that is required. The heat
rate is easily determined by multiplying either side of Equation (4.5) by the
mass flow rate (m˙ ) of the process gas stream. The heat rate required is given by
</p>

<img src="img/cpt3.png">

<p class="indent">Equation (4.6) can therefore be used to compute the heat rate required to raise the
gas temperature from T1 to T2. These equations are simple heat (enthalpy) balances.
They do not account for any heat losses in the system. Heat losses from refractory or
ducting are usually accounted for by assuming a fixed percent (or fraction) of the total
theoretical heat is lost. For example, if an afterburner is required to supply heat at the
rate of 1106 Btu/hr and there is a 10% heat loss from the combustion chamber, the
total heat rate would have to be 1.1106 Btu/hr to account for the losses.</p>



<p class="indent">The following procedure for calculating fuel requirements and physical design of an
incinerator are available in the literature and are presented below.</p>

<p class="indent">Note: This design procedure was originally developed by Dr. Louis Theodore in
1985 and later published by others. This was done without properly acknowledging
the author, a violation of the copyright laws.</p>

<p class="indent">1. Employing Equations (4.2–4.6), calculate the heat load required to raise the
process shown from its inlet temperature to the operating temperature of the combustion device:</p>

<img src="img/qah.png"><br>
<img src="img/qah1.png">
...
<div class="container">
    ...
    <a href="air_book1_lesson4.2.1.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.3.php" class="btn btn-primary">CONTINUE</a>
</div>
