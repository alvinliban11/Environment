...
<p><b>6.34 Benzene and Pyridine Application

</b></p>

<p>A vertical 10-ft-diameter vessel is used to adsorb 40 ppm benzene and 30 ppm
pyridine from air stream at 1 atm and 708F. The superficial velocity through
the vessel is 64 ft/min. The adsorbent is 4 6 mesh activated carbon having
a bulk density 30 lb/ft3
. Inlet concentrations indicate that the equilibrium
capacities for benzene and pyridine are 0.12 and 0.19, respectively. The
working charge can be assumed equal to 80% of the ideal value.
Determine the pressure drop and the amount of adsorbent in the bed if the bed
is in operation 5 days a week, 24 hr a day. Use the EPA chart (Figure 6.8) to
estimate the pressure drop.<br>
Solution: Preliminary calculations are provided below:
</p>

<img src="img/sd40.png">
<br>
<img src="img/sd41.png">
<img src="img/sd42.png">
<br>
...
<div class="container">
   <a href="air_book1_lesson6.3.12.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson6.3.14.php" class="btn btn-primary">CONTINUE</a>
</div>
