...
<p><b>3.14 Ideal Gas Law Volume Calculation
</b></p>

<p >Calculate the volume (in ft3
) of 1.0 lbmol of any ideal gas at 608F and 14.7 psia.<br>
...
<p>This result is another important number to remember in air pollution
calculations—1 lbmol of any (ideal) gas at 608F and 1 atm occupies 379 ft3
.</p>

<p><b>3.15 Gas Density
</b></p>



<p >Calculate the density of a gas (MW ¼ 29) in g/cm3 at 208C and 1.2 atm using
the ideal gas law. <br>Solution: Calculate the density of the gas again using the ideal gas law:</p>

<img src="img/mv.png">

<p>The effects of pressure, temperature, and molecular weight on density can be
obtained directly from the ideal gas law equation. Increasing the pressure and
molecular weight increases the density; increasing the temperature decreases
the density.</p>

<p><b>3.16 Incinerator Flow Rate
</b></p>

<p >Data from an incinerator indicate a volumetric flow rate of 30,000 acfm (608F,
1 atm). If the operating temperature and pressure of the unit are 11008F and
1 atm, respectively, calculate the flow rate in standard cubic feet per minute.<br>
Solution: Since the pressure remains constant, calculate the standard cubic feet
per minute using Charles’ law:
</p>

<img src="img/qs.png">

<p>The reader is again cautioned on the use of acfm and/or scfm. Predicting the
performance of and designing equipment should always be based on actual
conditions. Designs based on standard conditions can lead to disastrous
results, with the unit underdesigned. The reader is also reminded that absolute
temperatures and pressures must be employed in all ideal gas law calculations.</p>

<p><b>3.17 Vent Discharge Velocity
</b></p>



<p>The exhaust gas flow rate from a facility is 1000 scfm. All of the gas is vented
through a small stack that has an inlet area of 1.0 ft2
. The exhaust gas temperature
is 3008F. What is the velocity of the gas through the stack inlet in feet per
second? Assume standard conditions to be 708F and 1.0 atm. Neglect the
pressure drop across the stack.<br>
Solution: Calculate the actual flow rate, in acfm, using Charles’ law:
</p>
<img src="img/ta.png">

<p>Note that since the gas in vented through the stack to the atmosphere, the pressure
is 1.0 atm. Calculate the velocity of the gas:</p>

<img src="img/vqa.png">

<p><b>3.18 Flue Gas Analysis
</b></p>

<p >The mole percent (gas analysis) of a flue gas is given below:<br>
N2 ¼ 79%<br>
O2 ¼ 5%<br>
CO2 ¼ 10%<br>
CO ¼ 6%<br>
Calculate the average molecular weight of the mixture.<br>
Solution: First write the molecular weight of each component:<br>
MW(N2) ¼ 28<br>
MW(O2) ¼ 32<br>
MW(CO2) ¼ 44<br>
MW(CO) ¼ 28</p>
...
<div class="container">
   <a href="air_book1_lesson3.6.3.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson3.6.5.php" class="btn btn-primary">CONTINUE</a>
</div>
