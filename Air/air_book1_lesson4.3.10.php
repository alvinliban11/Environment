...
<p>If one starts off with 10mol of hydrogen and 10mol of nitrogen, and lets z represent the amount of nitrogen consumed by the end of the reaction, the output
amounts of all three components are 10 2 z for the nitrogen, 10 2 3z for the
hydrogen, and 2z for the ammonia. The following is a convenient way of representing the extent of reaction balance:
</p>
<img src="img/ch24.png">
<p>In this problem, the reader is asked to employ all three types of material balance
for the SO2 reaction.<br>
A flow diagram of the process is given in Figure 4.6.
(a) Using the molecular balance approach, one obtains</p>
<img src="img/ch25.png"><br>
<img src="img/ch26.png">



<p>Note: Since there are only two types of atoms, S and O, atomic balances can
provide only two equations. This is not enough for a system with three
unknowns. The oxygen output rate must be determined by one of the other
methods.
(c) Using the extent of reaction balances approach gives</p>
<img src="img/ch27.png">

<p>where z is the rate (lbmol/min) of SO2 reacted. Since the outlet O2 flow rate is
given as 300lbmol/min, then
</p>
<img src="img/ch28.png">
...
<div class="container">
    <a href="air_book1_lesson4.3.9.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.3.11.php" class="btn btn-primary">CONTINUE</a>
</div>
