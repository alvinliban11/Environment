...
<p><b>5.44 Recovery Versus Operating Costs: Breakeven Calculation
</b></p>



<p>A plant emits 50,000 acfm of air containing an organic gas at a concentration of
2.0 grains/ft3
. The gas is worth $0.01/lb. A theoretical equation has been previously developed relating the efficiency of gas absorption E to the pressure
drop DP (lbf/ft2
):

</p>

<img src="img/aw53.png">

<p>The fan is 55% efficient (overall) and electric power costs $0.03/(kw) (hr).<br>
(a) At what E is the cost of power equal to the value of the recovered (absorbed)
gas?<br>
(b) What is DP, in inches of H2O, at the condition in (a)?
Solution: The value of the recovered organic is</p>
<img src="img/aw54.png">



<p><b>5.45 Recovery Versus Operating Costs: Maximizing Profit
</b></p>

<p>Refer to Problem 5.44. At what efficiency will maximum profit be realized?<br>Solution: The profit (PR) in $/min is
</p>

<img src="img/aw55.png">
...
<div class="container">
   <a href="air_book1_lesson5.3.16.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson5.3.18.php" class="btn btn-primary">CONTINUE</a>
</div>
