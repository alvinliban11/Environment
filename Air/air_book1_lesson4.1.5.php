...
<div class="dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="air_book1_lesson4.1.php" style=" border-left: 7px solid green;">Lesson 4.1</a>
...
<div class="container">
    <h2>LESSON 4.1 INTRODUCTION</h2><br>


<p>Another important topic is combustion limits. Not all mixtures of fuel and air are
able to support combustion. The flammable or explosive limits for a mixture are the
maximum and minimum concentrations of fuel in air that will support combustion.
The upper explosive limit (UEL) is defined as the concentration of fuel which
produces a nonburning mixture due to a lack of oxygen. The aforementioned lower
explosive limit (LEL) is defined as the concentration of fuel which combustion will
not be self-sustaining. For example, consider a mixture of gasoline vapors and air that is at atmospheric conditions. The LEL is 1.4% by volume of gasoline vapors and
the UEL is 7.6%. Any concentration of gasoline in air within these limits will support
combustion, i.e., once a flame has been ignited, it will continue to burn. Concentrations
of gasoline in air below or above these limits will not burn and can quench the flame.
</p>

<p class="indent">The lower explosive limit is the more important of the two terms in describing gas
streams with combustible contaminants. Industrial processes that handle combustible vapors, such as paint or solvent vapors, are usually required by insurance
companies to operate at less than 25% of the LEL of the vapor in the ducts to
minimize fire hazards. By using gas analyzers and an alarm system, the concentration
of vapor may be allowed to be as high as 50% of the LEL by an insurance
company covering the plant. Also note that flammability limits are strong functions
of temperature.</p>
...
<div class="container">
   <span class="text-success">Completed</span>
      <a href="air_book1_lesson4.1.4.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.2.php" class="btn btn-primary">CONTINUE</a>
</div>
