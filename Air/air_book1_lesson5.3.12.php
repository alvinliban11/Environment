...
<p><b>5.36 Tower Height and Diameter

</b></p>



<p>A packed column is used to absorb a toxic pollutant from a gas stream. From
the data given below, calculate the height of packing and column diameter. The
unit operates at 50% of the flooding gas mass velocity, the actual liquid flow rate
is 40% more than the minimum, and 95% of the pollutant is to be collected.
Employ the generalized correlation provided in Figure 5.5 to estimate the column
diameter.
</p>


<p class="indent">Gas mass flow rate = 3500 lb/hr

</p>
<p class="indent">Pollutant concentration in inlet gas stream = 1.1 mol%


</p>
<p class="indent">Scrubbing liquid = pure water


</p>
<p class="indent">Packing type = l-inch Raschig rings; packing factor F = 160


</p>
<p class="indent">HOG of the column = 2.5 ft


</p>
<p class="indent">Henry’s law constant m = 0.98


</p>
<p class="indent">Density of gas (air) = 0.075 lb/ft3


</p>
<p class="indent">Density of water = 62.4 lb/ft3
</p>
<p class="indent">Viscosity of water =1.8 cP

</p>
<p class="indent">(c) 6.1
</p>
<p>Solution: To calculate the number of overall gas transfer units NOG, first calculate the equilibrium outlet concentration x1
 at y1 ¼ 0.011:</p>


<img src="img/aw33.png"><br>
<img src="img/aw34.png"><br>
<img src="img/aw35.png">
...
<div class="container">
   <a href="air_book1_lesson5.3.11.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson5.3.13.php" class="btn btn-primary">CONTINUE</a>
</div>
