...
<p><b>6.27 Breakthrough Time Calculation
</b></p>

<p>A degreaser ventilation stream contaminated with trichloroethylene (TCE) is
treated through the use of a horizontal carbon bed adsorber. The adsorber is normally designed to operate at a gas flow of 8000 scfm (608F, 1 atm), and the concentration of TCE at the adsorber inlet is 1500 ppmv. The capture efficiency of
the adsorber is 99% (Ec = 0.99) under normal design conditions. Design
parameters are as follows:
Actual conditions: 25psia, 908F
SAT = 35%
Z = depth of bed = 2.5 ft
L = length of adsorber = 2.5 ft
...
<img src="img/sd30.png">




<p><b>6.28 Transient Operation
</b></p>


<p>Refer to Problem 6.27. Recalculate the time before breakthrough occurs, based
on the following transient condition. The adsorber system is on line for one
hour at the previous normal design conditions when the inlet concentration of TCE rises to an average value of 2500 ppmv due to a malfunction in the degreaser process; the efficiency also drops to 97.5% during this time. Assume that the
SAT remains the same.<br>
Solution: For transient conditions
</p>




<img src="img/sd31.png">
...
<div class="container">
   <a href="air_book1_lesson6.3.9.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson6.3.11.php" class="btn btn-primary">CONTINUE</a>
</div>
