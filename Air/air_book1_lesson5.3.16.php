...
<img src="img/aw47.png"><br>
<img src="img/aw48.png">

<p>Once the volatile organic compounds (VOCs) have been recovered from a
process wastewater or groundwater stream, the off-gas (air/VOC mixture)
usually needs to be treated. This entails the installation of other equipment to
handle the disposal of the VOCs. Some typical methods include flaring,
carbon adsorption, and incineration. Flaring (see Chapter 4) is potentially hazardous because of the oxygen that is allowed to enter the flare header. Carbon
adsorption (see Chapter 6) can be an efficient means of recovering the VOCs
from the off-gas, but it can generate large quantities of solid hazardous
waste. A utility boiler (incineration) is probably the best alternative since
VOC destruction is typically more than 99%, and it is safer and more inexpensive. In addition, catalytic incinerators can also achieve high VOC destruction
efficiencies.</p>


<p><b>5.42 Number of Theoretical Plates Calculation
</b></p>



<p>Refer to Problem 5.28. Repeat calculations (a)–(c) as they apply to a plate
column. In effect, determine the number of theoretical plates N. Employ
Equation (5.23).<br><br>
Solution: Equation (5.23) applies for a plate column:
</p>

<img src="img/aw49.png"><br>
<img src="img/aw50.png">




<p><b>5.43 Raschig Rings versus Tellerettes Economic Comparison

</b></p>

<p>A small packed absorption tower is being designed to remove ammonia from air
by scrubbing with water at 688F and 1 atm. It was decided to use either 1-inch
Raschig rings or 1-inch Tellerettes as the packing in the tower. The value of
NOG is 6.0 for either packing, but the HOG for the Raschig rings is 2.5 ft and
that for Tellerettes is 1.0 ft. Each 1-inch Raschig ring costs $57.56/ft3 and each
Tellerette costs $26.40/ft3
. The installed cost of the tower shell is $18.30 per
foot of tower height. Determine which of the packings will be the more economical
for the system. Assume a tower diameter of 20 inches for both cases.<br><br>
Solution: For a Raschig ring tower, the required packing height is</p>


<img src="img/aw51.png"><br>
<img src="img/aw52.png">


<p>The cost of a Raschig ring tower is 1.14 (14%) times the cost of a Tellerette
packed tower in this service. In addition, the pressure drop will be significantly
lower with the Tellerettes.
</p>
...
<div class="container">
   <a href="air_book1_lesson5.3.15.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson5.3.17.php" class="btn btn-primary">CONTINUE</a>
</div>
