  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <a class="dropdown-item" href="air_book1_lesson7.3.php">Lesson 7.3</a>
     <a class="dropdown-item" href="air_book1_lesson7.4.php">Lesson 7.4</a>
      <a class="dropdown-item" href="air_book1_lesson7.5.php" style=" border-left: 7px solid green;">Lesson 7.5</a>
...
<div class="container">
 ...
 <h2>7.5 PARTICLE SIZE DISTRIBUTION</h2><br>
...
<div class="container">
   <a href="air_book1_lesson7.4.1.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson7.5.1.php" class="btn btn-primary">CONTINUE</a>
</div>
