...
<div class="dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="air_book1_lesson2.1.php" style=" border-left: 7px solid green;">Lesson 2.1</a>
...
<div class="container">
    <h2>LESSON 2.1: AIR POLLUTION REGULATORY
FRAMEWORK</h2>



<p class="indent">It is now 1970, a cornerstone year for modern environmental policy. The National
...
of demonstrators gathered all around the nation. NEPA and Earth Day were the beginning of a long, seemingly never-ending debate over environmental issues. <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
Reorganizational Plan 3 of 1970 that a single, independent agency be established, separate from the CEQ. The plan was sent to Congress by President Nixon on July 9, 1970,
and this new US Environmental Protection Agency (EPA) began operation on December
2, 1970. The EPA was officially born.<br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
In many ways, the EPA is the most far-reaching regulatory agency in the federal
government because its authority is so broad. The EPA is charged by the Congress of the United States of America to protect the nation’s land, air, and water systems. Under a
...
natural systems to support and nurture life<br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The EPA works with the states and local governments to develop and implement
...
This chapter presents the regulatory framework governing air management. It provides an overview of environmental laws and regulations used to protect human health
and the environment from the potential hazards of air pollutants.</p>
...
<div class="container">
   <span class="text-success">Completed</span>
     <a href="air_book1_lesson1.3.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson2.2.php" class="btn btn-primary">CONTINUE</a>
</div>
