...
<p><b>4.24 Evaluating Stoichiometric Coefficients
<p>Balance the following:</p>
<img src="img/ch13.png">


</b></p>

<p>Refer to Problem 4.21. How much of each product is formed (lb)? <br>
Solution: The limiting reactant is used to calculate the amount of products
formed:
</p>

<p>Find all Greek stoichiometric coefficients, i.e., express them in terms of the
English coefficients x, y, z, w, and u.<br>
Solution: Proceed sequentially for each element:</p>

<img src="img/ch13.png">



<p><b>4.25 Incinerator Application
</b></p>
<p>C6H5Cl is fed into a hazardous waste incinerator at a rate of 5000 scfm
(608F, 1 atm) and is combusted in the presence of air fed at a rate of
3000 scfm (608F, 1 atm). Both streams enter the incinerator at 708F.
Following combustion, the products are cooled from 20008F and exit a
cooler at 1808F. At what rate (lb/hr) do the products exit the cooler? The
molecular weight of C6H5Cl is 112.5; the molecular weight of air is 29.
Solution: Convert scfm to acfm using Charles’ Law for both chlorobenzene (q1)
and air (q2):</p>



<img src="img/ch15.png"><br>
<img src="img/ch16.png">
...
<div class="container">
    <a href="air_book1_lesson4.3.6.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.3.8.php" class="btn btn-primary">CONTINUE</a>
</div>
