...
<p><b>3.21 Vapor Pressure Calculation
</b></p>

<p>Two popular equations that are used to estimate the vapor pressure of compounds
are the Clapeyron and Antoine equations. The Clapeyron equation is given by</p>

<img src="img/inp.png">


<p>where p0 and T are the vapor pressure and temperature, respectively, and A and B
are the experimentally determined Clapeyron coefficients. The Antoine equation
is given by
</p>
...
<p>where A, B, and C are the experimentally determined Antoine coefficients.<br>
Use the Clapeyron and Antoine equations to estimate the vapor pressure of
acetone at 08C. The Clapeyron coefficients have been experimentally determined
to be<br>
A = 15:03<br>
B = 2817<br>
for p0 and T in mm Hg and K, respectively. The Antoine coefficients are<br>
A = 16:65<br>
B = 2940<br>
C = 35:93<br>
with p0 and T in the same units.<br>
Solution: First, calculate the vapor pressure p0 of acetone at 08C using the
Clapeyron equation:</p>

<img src="img/inp3.png">

<p >The Clapeyron equation generally overpredicts the vapor pressure at or near
ambient conditions. The Antoine equation is widely used in industry and
usually provides excellent results. Also note that, contrary to statements appearing in the Federal Register and some EPA publications, vapor pressure is not a
...
<div class="container">
    <a href="air_book1_lesson3.6.6.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson3.6.8.php" class="btn btn-primary">CONTINUE</a>
</div>
