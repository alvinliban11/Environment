...
<p><b>4.32 Enthalpy of Combustion

</b></p>

<p>Find the enthalpy of combustion of cyclohexane from enthalpy of formation
data. Perform the calculation for both liquid and gaseous cyclohexane. The
enthalpy of formation (258C) data are listed in Table 4.2.</p>
<img src="img/ch35.png"><br>
<img src="img/ch36.png">



<p>where (DH8f)i is the standard enthalpy of formation of species i. Thus, the (standard) enthalpy of a reaction is obtained by taking the difference between the
(standard) enthalpy of formation of products and reactants. If the (standard)
enthalpy of reaction or formation is negative (exothermic), as is the case with
most combustion reactions, then energy is liberated because of the chemical reaction. Energy is absorbed if DH8 is positive (endothermic).<br>
The balanced combustion equation for liquid (l) cyclohexane C6H12 is</p>
<img src="img/ch37.png"><br>

<p>Tables of enthalpies of formation, combustion, and reaction are available in the
literature (particularly thermodynamics texts/reference books) for a wide variety
of compounds. It is important to note that these are valueless unless the stoichiometric equation and the states of the reactants and products are included.
However, enthalpy of reaction is not always employed in engineering
reaction/combustion calculations. The two other terms have been used are the
gross (or higher) heating value and the net (or lower) heating value both of
which were briefly reviewed in Section 4.2. These are discussed in the next
problem.</p>
...
<div class="container">
   <a href="air_book1_lesson4.3.12.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.3.14.php" class="btn btn-primary">CONTINUE</a>
</div>
