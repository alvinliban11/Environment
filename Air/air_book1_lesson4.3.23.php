...
<p><b>4.43 Minimizing Incinerator Volume

</b></p>

<p>A fluidized-bed incinerator is to be designed to destroy 99.99% of a unique
hazardous waste. On the basis of laboratory and pilot plant studies, researchers
have described the waste reaction by a first-order reversible mechanism. Their
preliminary findings are given here:
</p>
<img src="img/ch63.png">

<p>Calculate a fluidized-bed incinerator operating temperature that will minimize the
volume of the incinerator and achieve the desired degree of waste conversion
(destruction). The operating temperature must be in the 1400–17008F range.<br>
Solution: A fluidized-bed incinerator is best described (see text referenced in
previous problem) by a continuous stirred-tank reactor (CSTR) as provided
in Equation (4.25).</p>

<img src="img/ch64.png">

<p>For 99.99% destruction of the waste A, the conversion of A (XA ¼ moles of A
reacted per mole A initially present) becomes</p>

<img src="img/ch65.png">
<p>There are simpler approaches that could have been used to solve this problem.
For example, the right side of the design equation could be plotted against temperature (on which the k values depend) to determine the minimum of the
function.</p>
...
<div class="container">
   <a href="air_book1_lesson4.3.22.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.3.24.php" class="btn btn-primary">CONTINUE</a>
</div>
