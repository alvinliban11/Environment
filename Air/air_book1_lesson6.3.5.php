...
<p><b>6.18 Working Charge Calculation

</b></p>

<p>The saturated carbon capacity in a 3-ft adsorption bed is 39%. The MTZ and
HEEL were determined to be 4 inches and 2.5%, respectively. Calculate the
working charge in percent.<br>
(a) 41.5<br>
(b) 36.5<br>
(c) 34.3<br>
(d) 32.0<br>
Solution: First note that answer (a) is not possible since it is greater than the CAP
specified. The describing equation is</p>

<img src="img/sd12.png">


<p><b>6.19 MTZ Calculation


</b></p>

<p>The following data sheet was extracted from a company’s files.<br>
Test performed: measurement of length of MTZ, 20C<br>
Material tested: carbon “B”<br>
Test number: B–17<br>
Conditions:<br><br>
Carbon bed depth = 62.0 cm (2.0 ft)<br>
Saturation capacity = 26% at 20C<br>
Temperature of test = 20C<br>
Breakthrough capacity = 24.9% (calculated from test)<br>
Calculate the MTZ in centimeters and inches. Comment on the result.
Solutions: Apply Equation (6.1).</p>

<img src="img/sd13.png">

<p>For activated carbon, MTZs of 2–4 inches are to be expected. For tall beds, the
MTZ effect may be neglected.</p>
...
<div class="container">
   <a href="air_book1_lesson6.3.4.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson6.3.6.php" class="btn btn-primary">CONTINUE</a>
</div>
