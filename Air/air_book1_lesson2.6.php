    ...
    <a class="dropdown-item" href="air_book1_lesson2.3.php">Lesson 2.3</a>
     <a class="dropdown-item" href="air_book1_lesson2.4.php">Lesson 2.4</a>
      <a class="dropdown-item" href="air_book1_lesson2.5.php">Lesson 2.5</a>
       <a class="dropdown-item" href="air_book1_lesson2.6.php" style=" border-left: 7px solid green;">Lesson 2.6</a>
  </div>
</div>
...
<div class="container">
    <h2>LESSON 2.6: CLOSING COMMENTS AND RECENT DEVELOPMENTS</h2>


<p>Today, more than 35 years after the 1970 Clean Air Act was adopted, and 18 years after
its last major revision, many areas of the country continue to experience difficulty in
meeting established ambient air standards, and the EPA is embarking on new programs
to ensure that the air is clean.<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
The Agency is currently working on several programs to manage a range of
developing air quality issues. Two of the more prominent of these issues are greenhouse
gases (such as carbon dioxide) that affect global climate, and fine particulate matter,
referred to also as PM2.5 (or particulate matter less than 2.5mm in diameter) that can
produce regional haze and reduce visibility in otherwise pristine regulatory environments. Action on nanoparticles (less than 0.1mm) has been discussed but appears (at
the time of the preparation of this text) to be in limbo. These and other developing air
issues (e.g., vapor intrusion)—and new issues not yet on the horizon—represent challenges for the EPA that may prompt Congress to review and amend the Clean Air Act
again in the coming years.<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Finally, the reader should note that EPA’s early “Command-and-Control” regulatory standards of the 1970s and 1980s have been replaced by less costly and more flexible
standards as well as risk-based standards. In addition, “surrogate” regulators, such as
lawyers, bankers, and accountants, have (perhaps fortunately) also contributed to
insure corporate environmental responsibility.</p>
...
<div class="container">
    ...
    <a href="air_book1_lesson2.5.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson3.1.php" class="btn btn-primary">CONTINUE</a>
</div>
