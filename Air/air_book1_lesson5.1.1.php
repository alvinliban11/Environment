...
<p>the packing and on the inside wall of the column should be redistributed after a bed
...
<p class="indent">Crossflow packed scrubbers are particularly successful when the process air stream
requires both gas absorption and particulate removal. The crossflow scrubber operates by
allowing the gas to flow horizontally across the scrubber. The scrubbing liquid is introduced at the top of the scrubber and drains vertically through the packing. Contact
between the gas and liquid occurs at a right angle.</p>
...
<p class="indent">In general, crossflow scrubbers operate at lower pressure drops and liquid recycle
...
at much higher gas-to-liquid ratios than does the countercurrent packed-bed absorber.</p>

<p class="indent">As a result, the liquid stream in the crossflow scrubber is able to “scour” the packing
...
<p class="indent">It is also easier to increase the gas flow rate through an existing crossflow absorber
than a countercurrent packed-bed absorber since the crossflow scrubber can operate
over a wider range of gas-to-liquid ratios. Another advantage associated with the crossflow absorber is that it can be installed horizontally in-line on an existing process. Many
...
can achieve very high removal efficiencies for pollutants that are difficult to absorb.<br>
...
manner depicted schematically in Figure 5.2. The liquid enters at the top and flows downward via gravity. On the way, it flows across each plate and through a downspout (or downcomer) to the plate below. The gas passes upward through hole openings in the plate, then
...
<p class="indent">liquid. Each plate of the column is a stage. Since the fluids on the plate are brought into
...
carried out and is determined solely from material balance and equilibrium considerations.
...
on the quantities of liquid and gas flowing through the column per unit time.<br>
...
Figure 5.2 demonstrates the vapor–liquid action for a bubble-cap plate. Although
...
spaced approximately 24 inches apart.</p>
...
<div class="container">
   <a href="air_book1_lesson5.1.1.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson5.2.php" class="btn btn-primary">CONTINUE</a>
</div>
