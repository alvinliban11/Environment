...
<p><b>4.38 Available Heat Calculation</b></p>

<p>A 1.75  10^6 acfm process gas stream essentially consisting of air enters a boiler
at 608F and 14.7psia and is to be incinerated at 2000F. The boilers dimensions
are 36 m 10.5 m 12 m. A natural gas with a gross heating value of 1059Btu/
scf is to be used with (primary) stoichiometric air for fuel. The combustion of
natural gas with stoichiometric air produces 11.5mol of flue gas/mol of
natural gas.<br>
(a) Find the required natural gas flow rate in scfm (608F, 1atm).<br>
(b) Calculate the available heat (HA) in Btu/scf.<br>
(c) Does the unit meet the required residence time of 0.75 s?<br>
Solution: This is similar to Problems 4.36 and 4.37, but with some SI units.
Refer to Table 4.5.
</p>
<img src="img/ch51.png"><br>
<img src="img/ch52.png">
...
<div class="container">
   <a href="air_book1_lesson4.3.17.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.3.19.php" class="btn btn-primary">CONTINUE</a>
</div>
