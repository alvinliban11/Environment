...
<p >The basic units employed in the SI system are (select one):</p>
<p >(a) Mass, length, and force</p>
<p >(b) Force, length, time, and mass
</p>
<p>(c) Mass, length, and time
</p>
<p >(d) None of the above
</p>
<p >Solution: The reader is referred to the Appendix for this answer. The basic units
in the SI system are the kilogram (mass), meter (length), second (time), Kelvin
(temperature), ampere (electric current), candela (the unit of luminous intensity),
and radian (angular measure). All have come to be used by the engineer. The
Celsius scale of temperature (08C ¼ 273.15 K) is commonly used with the absolute Kelvin scale. The correct answer is therefore (d).</p>

<p><b>3.2 Temperature Conversions
</b></p>



<p>Perform the following temperature conversions:<br>
(a) Convert 558F to (1) Rankine, (2) Celsius, and (3) Kelvin<br>
(b) Convert 558C to (1) Fahrenheit, (2) Rankine, and (3) Kelvin
Solution
</p>
<img src="img/sol.png">

<p><b>3.3 Definition of Absolute Zero
</b></p>


<p>At absolute zero temperature a gas has:
(a) A temperature of 2273.158C <br>(b) No kinetic energy<br>
(c) No pressure<br>
(d) All of the above<br>
Solution: Interestingly, a gas at absolute zero temperature (0K) satisfies answers
(a)–(c). The correct answer is therefore (d).</p>

<p><b>3.4 Definition of Absolute Pressure</b></p>

<p>Absolute pressure is:
(a) Measured above a perfect vacuum<br>
(b) 29.92 in Hg<br>
(c) Required for proper gauge pressure readings<br>
(d) Pabs ¼ Patm þ Pgauge<br>
Solution: This is a tricky question. Answers (c) and (d) can be eliminated
immediately. Normally, but not always, absolute pressure is approximately
29.92 in Hg. However, by definition, absolute pressure</p>

<p><b>3.5 Pressure Calculations</b></p>


<p>The height of a liquid column of mercury open to the atmosphere is 2.493 ft.
Calculate the absolute pressure at the base of the column in lbf/ft2
, psia, mm Hg,
and in H2O. Assume that the density of mercury is 848.7 lb/ft3 and atmospheric
pressure is 2116 lbf/ft2 absolute. <br>Solution: Expressed in various units, the standard atmosphere is equal to</p>

<p class="indent">1.0 Atmospheres (atm)</p>
<p class="indent">33.91 Feet of water (ft H2O)
</p>
<p class="indent">14.7 Pounds-force per square inch absolute (psia)
</p>
<p class="indent">2116 Pounds-force per square foot absolute (psfa)
</p>
<p class="indent">29.92 Inches of mercury (in Hg)
</p>
<p class="indent">760.0 Millimeters of mercury (mm Hg)
</p>
<p class="indent">1.013  105 Newtons per square meter (N/m2
</p>


<p>The equation describing the pressure at the base of the column height due to the
liquid is</p>
...
<p><b>3.6 Effect of Volume Change on Viscosity</b></p>


<p>As the volume of a gas increases at the same pressure and temperature, the
viscosity of the gas generally <br>
(a) Increases<br>
(b) Decreases<br>
(c) Remains the same<br>
(d) Varies sinusoidally<br>
Solution: Since the temperature and pressure are the same, the volume change of
the gas has no effect on the viscosity. The correct answer is therefore (c).
</p>
...
<div class="container">
     <a href="air_book1_lesson3.6.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson3.6.2.php" class="btn btn-primary">CONTINUE</a>
</div>
