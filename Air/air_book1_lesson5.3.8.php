...
<img src="img/aw16.png">

<p>The corresponding values for x2 = 0.003, 0.05, and 0.065 (employing the same
procedure above) are 7.45, 9.66, and 13.5, respectively. The reader is left with
the exercise of repeating the calculations [(a)–(c)] for the number of theoretical
stages or plates (N) for a plate tower. (This is addressed in Problem 5.42.)<br>
(c) The separation becomes impossible when</p>
<img src="img/aw17.png">

<p><b>5.29 Outlet Concentration from a Spray Tower

</b></p>

<p>A waste incinerator emits 300 ppm HCl with peak values of 600 ppm. The
airflow is a constant 5000 acfm at 758F and 1atm. Only sketchy information
was submitted with the scrubber permit application to the state agency for a
spray tower. You are requested to determine if the spray unit is satisfactory.</p>
<p class="indent">Data
<p class="indent">Emission limit ¼ 30ppm HCl
</p>
<p class="indent">Maximum gas velocity allowed through the tower ¼ 3 ft/s
</p>
<p class="indent">Number of sprays ¼ 6
</p>
<p class="indent">Diameter of the tower ¼ 10 ft</p>
</p>

<p>The number of transfer units NOG to meet the regulations, assuming the worstcase scenario, is
</p>
<img src="img/aw18.png">

<p>As a rule of thumb in a spray tower, the NOG of the first or top spray is 0.7. Each
lower spray will have approximately 60% of the NOG of the spray above it. The
absorption that occurs in the inlet duct adds no height but has an NOG of 0.5.<br><br>
Solution: First, check the gas velocity:</p>
<img src="img/aw19.png"><br>
<img src="img/aw20.png">
...
<div class="container">
   <a href="air_book1_lesson5.3.7.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson5.3.9.php" class="btn btn-primary">CONTINUE</a>
</div>
