...
<p>Depending on the user, the above terms can also have more than one definition. For
example, a laboratory chemist may describe latent heat as the energy used in the chemical combustion of a fuel to carbon dioxide and water; while a boiler operator may
describe latent heat as the difference between the gross and net heating values.
</p>

<p class="indent">As discussed in Chapter 3, another important term used in performing combustion
calculations is the specific heat, or more appropriately the heat capacity cp, of a
substance. One set of units for heat capacity is Btu/lb . 8F in English units. Heat capacity
also depends on temperature (see Chapter 3).</p>

<img src="img/fig4.5.png">

<p class="indent">An area of concern in incineration deals with calculations involving sensible heat
and heat (energy) balances. Some approaches with key concepts and equations are presented below.</p>

<p class="indent">1. Compute the heat required to perform a heat balance around the combustion
system. From the law of conservation of energy (for steady-state conditions):</p>

<p class="indent1">heat in = heat out</p>

<p class="indent">As discussed earlier, heat is a relative term that is compared at a reference temperature.
The heat content of a substance is arbitrarily taken as zero at a specified reference
temperature. In the gas industry (natural gas), the reference temperature employed
is normally 608F.</p>

<p>2. The heat content can be computed from Equation (4.3) as well as using tables
such as Table 4.1.
...
<p class="indent1">3. Subtracting the heat going in from the heat leaving the system gives the heat that
must be supplied by the fuel. This is referred to as a change in enthalpy or heat
content. Using Equation (4.3), the enthalpy going in (T1) is subtracted from the
enthalpy leaving (T2), giving.</p>

<img src="img/cpt1.png">




<p class="indent">4. To simplify this calculation, an average specific heat value (cp) can be used over
the temperature range involved. This reduces Equation (4.4) to</p>

<img src="img/cpt2.png">

<p class="indent">The heat capacity varies with temperature and composition of the gas
stream. Therefore, Equation (4.5) is used to obtain an approximate value. For
most incineration systems, the waste gases are considered to be essentially air.
For air, the average heat capacity value cp is 0.26 Btu/lb . 8F for typical temperature ranges normally encountered in fume incinerators.</p>
...
<div class="container">
    <a href="air_book1_lesson4.2.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.2.2.php" class="btn btn-primary">CONTINUE</a>
</div>
