...
<p>Twhere FR is the resultant or net force, F is the external force, FB is the buoyant force, and
FD is the drag force. The net force results in acceleration of the particle, given by
</p>


<img src="img/sd78.png">



<p class="indent">where m is the mass of the particle (pdp
3
rp/6); and rp is the particle density. The external
force per unit mass is denoted as f. The external force F on the particle is then
</p>


<img src="img/sd79.png">

<p class="indent">Unless the particle is in a vacuum, it will experience a buoyant force in conjunction with
the external force(s); this is given by
</p>
<img src="img/sd80.png"><br>
<img src="img/sd81.png">
...
<div class="container">
   <a href="air_book1_lesson7.3.1.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson7.3.3.php" class="btn btn-primary">CONTINUE</a>
</div>
