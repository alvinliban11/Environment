...
<p>1. Select adsorbent type and size.<br>
...
try to minimize regeneration time.<br>
3. Set velocity; v is usually 80 ft/min, but can be increased to 100 ft/min.<br>
4. Set steam/solvent ratio.<br>
5. Calculate (or obtain) WC for the above.<br>
6. Calculate amount of solvent adsorbed during 1/
2 cycle time, Ms.<br>
7. Calculate adsorbent required, MAC.</p>


<img src="img/as14.png">
...
<div class="container">
   <a href="air_book1_lesson6.2.2.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson6.3.php" class="btn btn-primary">CONTINUE</a>
</div>
