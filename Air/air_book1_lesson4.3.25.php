...
<p><b>4.46 Theoretical Flame Temperature Estimation
</b></p>

<p>Estimate the theoretical flame temperature of a waste mixture containing 25%
cellulose, 35% motor oil, 15% water (vapor), and 25% inerts, by mass.
Assume 5% radiant heat losses. The flue gas contains 11.8% CO2, 13% CO,
and 10.4% O2 (dry basis) by volume.
</p>
<img src="img/ch73.png">

<p>Assume that the average heat capacity of the flue gas is 0.325Btu/(lb . 8F).
Employ the Theodore and Reynolds (TAR) equation to perform this calculation</p>

<img src="img/ch74.png"><br>
<img src="img/ch75.png">

<p><b>4.47 Coil-Coating Operation
</b></p>

<p>A decision has been made to control the volatile organic emissions from a coilcoating operation with a combustion device. Discuss and/or outline the pros and
cons of control via thermal versus catalytic incineration.<br>
Solution: This is, to some extent, an open-ended question. The main concern is
whether particulates (or other solid matter) will be present in the emission from
the operation. The path of least resistance is to employ a thermal unit since the
formation of any particulate would significantly reduce the effectiveness of a
catalytic unit.</p>

<p>NOTE: Additional problems are available for all readers at www.wiley.com. Follow
links for this title.</p>
...
<div class="container">
   <a href="air_book1_lesson4.3.24.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson5.1.php" class="btn btn-primary">CONTINUE</a>
</div>
