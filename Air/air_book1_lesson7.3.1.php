...
<p>This is the straight-line portion of the log–log plot of CD vs. Re (Figure 7.3). For higher
values of the Reynolds number, it is almost impossible to perform purely theoretical calculations. However, several investigators have managed to estimate, with a considerable
amount of effort, the drag and/or drag coefficient at higher Reynolds numbers.
</p>
<p>In addition to the analytical equation [Equation (7.8)], one may use
</p>

<img src="img/sd71.png">



<p class="indent">for the “intermediate” range (i.e., between the Stokes’ law range and the Newton’s law
range, discussed later). This indicates a lesser dependence than Stokes’ law on Re; it is
less accurate than Stokes’ law for Re , 2. At higher Re the drag coefficient is approximately constant. This is the Newton’s law range, for which
</p>


<img src="img/sd72.png">

<p class="indent">In this region the drag force—see Equation (7.3)—on the sphere is proportional to the
square of the gas velocity. (Note that Newton’s law for the drag force is not to be
confused with Newton’s law of viscosity or Newton’s laws of motion.)<br>
A simple two-coefficient model of the form
</p>
<img src="img/sd73.png">

<p>can be used over the three Reynolds number ranges given in Equations (7.8)–(7.10). The
numerical values of a and b are given in Table 7.1.</p>
<img src="img/sd74.png">

<p>for the Newton’s law range (500 , Re , 200,000). This two-coefficient, threeReynolds-number range model will be used for drag force calculations in this and subsequent chapters. A review of this model and these equations indicates that they are fairly
consistent with the experimental values found in the literature.
Another empirical drag coefficient model is given by Equation (7.16).</p>


<img src="img/sd75.png">



<p>This is an empirical equation (L. Theodore: personal notes, 1974) that was obtained by
the use of a statistical fitting technique. This correlation gives excellent results over the entire range of Reynolds numbers. An advantage of using this correlation is that it is not
partitioned for application to only a specific Reynolds number range.<br>
Still another empirical equation is (S. Barnea and I. Mizraki, PhD thesis, Haifa
University, Haifa, 1972):</p>

<img src="img/sd76.png">



<p class="indent">This correlation is also valid over the entire spectrum of Reynolds numbers. Its agreement with literature values is generally good. However, in the range of 30 , Re ,
10,000, there is considerable deviation. For Re , 30 or Re . 10,000, the agreement
is excellent.
</p>


<p class="indent">Consider now a solid spherical particle located in a gas stream and moving in one
direction with a velocity v relative to the gas. The net or resultant force experienced by
the particle is given by the summation of all the forces acting on the particle. These
forces include drag, buoyancy, and one or more external forces (such as gravity, centrifugal, and electrostatic). In order to simplify the presentation, the direction of particle
movement relative to the gas is always assumed to be positive. Newton’s law of
motion is then</p>
</p>


<img src="img/sd77.png">
...
<div class="container">
   <a href="air_book1_lesson7.3.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson7.3.2.php" class="btn btn-primary">CONTINUE</a>
</div>
