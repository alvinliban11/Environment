...
<p><b>4.40 Plan Review of a Catalytic Afterburner

</b></p>

<p>Plans have been submitted for a catalytic afterburner. The installed afterburner is
to incinerate a 3000 acfm contaminated gas stream discharged from a direct-fired
paint baking oven at 3508F. The following summarizes the data taken from
the plans:
</p>

<p>Data Sheet<br>
Exhaust flow rate from oven: 3000 acfm<br>
Exhaust gas temperature from oven: 3508F<br>
Solvent emission to afterburner: 0.3 lb/min<br>
Final temperature in afterburner: 10008F<br>
Gross heating value of natural gas: 1100 Btu/scf<br>
Total heat requirement: 26,884 Btu/min<br>
Natural gas requirement: 35.0 scfm<br>
Furnace volume: 46.0 ft3<br>
Exhaust flow rate from afterburner at 10008F: 6350 acfm<br>
Gas velocity through catalytic bed: 8.6 ft/s<br>
Number of type A 19  24  3.75 inch catalyst elements: 4</p>

<p>The following additional information and rules of thumb may be required to
review the plans for the catalytic afterburner:<br>
1. Heat will be recovered from the afterburner effluent, but that process will not
be considered in this problem.<br>
2. Catalytic afterburner operating temperatures of approximately 9508F have
been found sufficient to control emissions from most process ovens.<br>
3. Preheat burners are usually designed to increase the temperature of the contaminated gases to the required catalyst discharge gas temperature without
regard to the heating value of the contaminants (especially if considerable
concentration variation occurs).<br>
4. A 10% heat loss is usually a reasonable estimate for an afterburner. This may
be accounted for by dividing the calculated heat load by 0.9.<br>
5. The properties of the contaminated effluent may essentially be considered
identical to those of air.<br>
6. The natural gas is combusted using near stoichiometric (0% excess) external air.<br>
7. The catalyst manufacturer’s literature suggests a superficial gas velocity
through the face surface of the catalyst element (in this case 19 inches
24inches) of 10ft/s.<br>
Two key questions are to be considered:<br>
(a) Is the operating temperature adequate for efficiency control?<br>
(b) Is the fuel requirement adequate to maintain the operating <br>temperature?
Solution: (a) The plans indicate a combustion temperature of 10008F; this is
acceptable when compared to a 9508F rule-of-thumb temperature.
(b) To determine whether the fuel requirement is adequate to maintain the operating temperature, first calculate the lbmol/min of gas to be heated from 3508F to
10008F.</p>


<img src="img/ch57.png"><br>
<img src="img/ch58.png">
...
<div class="container">
   <a href="air_book1_lesson4.3.19.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.3.21.php" class="btn btn-primary">CONTINUE</a>
</div>
