...
<p><b>5.26 NOG Calculation for a Highly Soluble Gas
</b></p>
<img src="img/aw13.png">

<p><b>5.27 Inlet Concentration for a Very Soluble Gas
</b></p>
<img src="img/aw14.png">



<p><b>5.28 NOG Calculations</b></p>


<p>(a) Find the number of overall gas transfer units (NOG) in a packed tower
required to remove 90% of a gas in an inlet air stream containing 10 mole
percent (mol%) of the pollution gas using pure water at a rate 20% greater
than the minimum rate. Assume m ¼ 1.485.<br>
(b) How manyNOG values would be required if instead of purewater, watercontaining 0.1, 0.3, 0.5, and 0.65 mol% (mole percent) of the gas were used instead?<br>
(c) What mole percent of the gas in water would make such a separation
impossible?<br>
Solution:<br>
(a) Calculations can be performed on a mole fraction or solute-free mole fraction
basis. Since y1 ¼ 0.1, the solute-free mole fraction is
</p>

<img src="img/aw15.png">
...
<div class="container">
   <a href="air_book1_lesson5.3.6.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson5.3.8.php" class="btn btn-primary">CONTINUE</a>
</div>
