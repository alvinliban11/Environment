...
<p><b>6.42 Stream Requirement for Bed Regeneration II</b></p>

<p>A process N2 stream contains 3.8 vol% toluene is to be recovered by adsorption.
The gas flow rate is 350 lb/min. A 4  10 mesh granular activated carbon, twobed unit, adsorbing at 808F is to be used. The bed depth is to be 2 ft and the
adsorption time 1 hr. Regeneration is to be accomplished with 25 psia steam.
No bed cooling is required. Bed switching is to be done at the onset of breakthrough, and 10% excess carbon is used in the beds. The carbon will retain
0.27 lb toluene/lb carbon at 808F. The bulk density is 30 lb/ft3<br>
(a) How much carbon is required for each bed?<br>
(b) What is the gas flow area if the bed height is 2 ft?<br>
(c) Estimate the pressure drop across the beds (use EPA chart).<br>
(d) During regeneration the vessel heat requirement is 100,000 Btu, the carbon
must by heated from 808F to the 25 psia steam temperature, (2408F) and the
heat of desorption is 50 Btu/lb of toluene. If the heat capacity of the carbon
is 0.25 Btu/lb8F, how much steam must be supplied for the regeneration of
the bed?
</p>

<img src="img/sd55.png"><br>
<img src="img/sd56.png"><br>
<img src="img/sd57.png"><br>
...
<div class="container">
   <a href="air_book1_lesson6.3.16.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson6.3.18.php" class="btn btn-primary">CONTINUE</a>
</div>
