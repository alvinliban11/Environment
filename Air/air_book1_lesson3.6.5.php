...
<p>Table 3.5 can be prepared by multiplying the molecular weight of each component by its mole percent.</p>

<img src="img/table3.5.png">

<p >The sum of the weights in pounds represents the average molecular weight because
the calculation above is based on 1.0 mol of the gas mixture. The reader should
also note that in a gas, mole percent equals volume percent and vice versa.
Therefore, a volume percent can be used to determine weight fraction as illustrated in Table 3.5. The term y is used in engineering practice to represent mole (or
volume) fraction of gases; the term x is often used for liquids and solids.
</p>


<p><b>3.19 Partial Pressure I
</b></p>

<p>The exhaust to the atmosphere from an incinerator has a SO2 concentration of
0.12 mm Hg partial pressure. Calculate the parts per million of SO2 in the
exhaust.<br>
Solution: First calculate the mole fraction y. By Dalton’s law</p>

<img src="img/yp.png">


<p>Since the exhaust is discharged to the atmosphere, the atmospheric pressure,
760 mm Hg, is the total pressure P. Thus,</p>
<img src="img/ppm.png">


<p><b>3.20 Partial Pressure II
</b></p>



<p >A storage tank contains a gaseous mixture consisting of 30% CO2, 5% CO, 5%
H2O, 50% N2, and 10% O2, by volume. What is the partial pressure of each component if the total pressure is 2 atm? What are their pure-component volumes if
the total pressure is 2 atm? What are the pure-component volumes if the total
volume is 10 ft3
? What are the concentrations in ppm (parts per million)? <br>
Solution: Dalton’s law states that the partial pressure pa of an ideal gas is
given by</p>



<img src="img/payap.png">

<p>Amagat’s law states that the pure component volume Va of an ideal gas is
given by</p>

<img src="img/vayav.png">

<p>Unless otherwise stated, ppm for gases is by mole or volume and is usually
designated as ppmv. When applying the term to liquids or solids, the basis is
almost always by mass; the notation may appear as ppmw or ppmm.</p>
...
<div class="container">
    <a href="air_book1_lesson3.6.4.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson3.6.6.php" class="btn btn-primary">CONTINUE</a>
</div>
