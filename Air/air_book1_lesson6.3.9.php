...
<div class="dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <a class="dropdown-item" href="air_book1_lesson6.3.php" style=" border-left: 7px solid green;">Lesson 6.3</a>
...
<div class="container">
 ...
 <h2>LESSON 6.3 OPERATION AND MAINTENANCE, AND IMPROVING
PERFORMANCE
</h2><br>
...
<p><b>6.25 Adsorber Capacity
</b></p>

<p>The operating temperature and pressure for a column are 168C and 1.2 atm, respectively. An acetone (molecular weight = 58) gas stream entersthe column at aconcentration of 100 ppm by volume. Activated carbon is used to remove the pollutant; its
bulk density is 0.575 g/cm3
. The activated carbon in the column has a saturation
capacity and HEEL of 55% and 4.5%, respectively, and the mass transfer zone is
0.15 m. The column is horizontal with the dimensions of 2.5 m in height,
30.75 m in length, and 6 m in diameter. The column cycles every 5 hr,
assume that to be the time in the adsorption mode. The adsorber recovers 98% by
weight of acetone. Assuming that the standard conditions are 218C, and 1 atm,
find the volumetric flow rate of the gas stream containing the acetone in scfm,
am3
/min, sm3
/min, acfm.<br><br>
Solution: This problem involves the use of SI units. First calculate BRK
and WC.
</p>

<img src="img/sd26.png"><br>
<img src="img/sd27.png">



<p><b>6.26 Sizing a Carbon Adsorber
</b></p>


<p>A printing company must reduce and recover the amount of toluene it emits from
its Rotograve printing operation. The company submits some preliminary information on installing a carbon adsorption system. You, the primary consultant, are
given the following information:<br><br>
Airflow = 20,000 acfm (778F, 1 atm)<br>
Adsorption capacity for toluene = 0.175 lb toluene/lb activated carbon<br>
Operation at 10% of LEL (lower explosivity limit) for toluene in the exit air
from printer<br>
LEL for toluene = 1.2%<br>
Toluene molecular weight = 92.1<br>
Carbon bulk density (46 mesh) = 30 lb/ft3<br>
Working charge = 60% of saturation capacity<br>
Regeneration just under one hour; assume 1.0 hr<br>
Maximum velocity through adsorber =100 fpm (ft/min)<br><br>


Determine the minimum size of adsorber you would recommend for a 1  1
system. Calculations should include the pertinent dimensions of the adsorber,
the amount of carbon, the depth of the bed and an estimate of the pressure
drop. Also calculate the fan horsepower if the blower/motor efficiency is 58%.<br><br>
Solution: Initially, base the calculations on 1 hr regeneration time so that 1 hr of
adsorption is available. Key calculations and results are provided below for the
toluene (TOL) and activated carbon (AC). Design for operation at 10% of LEL.</p>




<img src="img/sd28.png"><br>
<img src="img/sd29.png">
...
<div class="container">
   <a href="air_book1_lesson6.3.8.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson6.3.10.php" class="btn btn-primary">CONTINUE</a>
</div>
