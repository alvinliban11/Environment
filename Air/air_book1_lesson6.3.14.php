...
<p><b>6.35 Landfill Emissions


</b></p>

<p>Gas emissions are being collected from a landfill and must be treated before
being released into the environment. There are several options for treatment.
As one of the project engineers, you have been given the task to look at the
use of a horizontal activated carbon adsorber to collect the methane in the gas
stream (assume 95% removal). Perform the following calculations:<br>
1. Mass of CH4 collected per operating period<br>
2. Mass of activated carbon needed<br>
3. Depth of AC bed<br>
The following data are provided:<br><br>
Flow rate = 11,000 acfh<br>
Operating pressure of the adsorber = 1 atm<br>
Operating temperature of the adsorber = 708F<br>
Time between regeneration = 24 hr
</p>

<img src="img/sd43.png">
<br>
<img src="img/sd44.png">

<p><b>6.36 Vinyl Chloride Monomer Application
</b></p>

<p>It is desired to recover vinyl chloride monomer (VCM), MW = 62.5, from a side
stream at a PVC plant with a flow rate of 1000 acfm at 758F and 1.0 atm. The
stream contains 750 ppm VCM, and 99% recovery is desired. Using a 1  1,
4 10 mesh activated carbon system, determine a suitable bed diameter,
height, pressure drop through the bed, and horsepower requirements (Ef =
0.55). Assume a bulk density of 30 lb/ft3
, 8 hr of adsorption time, and a superficial velocity of 50 ft/min. After regeneration, the activated carbon is at equilibrium with the VCM at a partial pressure of 0.0001 psia. Neglect MTZ effects.
Equilibrium data at 758F and 1.0 atm are available in Table 6.7.
Solution:</p>

<img src="img/sd45.png"><br>
<img src="img/sd46.png">
...
<div class="container">
   <a href="air_book1_lesson6.3.13.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson6.3.15.php" class="btn btn-primary">CONTINUE</a>
</div>
