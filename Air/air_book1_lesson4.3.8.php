...
<p><b>4.26 Combustion with Excess Air</b></p>




<p>A 10,000 lbmol/hr gaseous mixture of benzene and toluene (70% benzene by
mole) is being burned in a thermal afterburner using 50% excess air.
Assuming complete combustion, determine the amount of air required (in
lbmol/hr) and the flow rate of the product gas in scfm (1atm, at 608F, 1atm).
Solution: The stoichiometric combustion equations for both benzene and
toluene are
</p>
<img src="img/ch17.png"><br>
<img src="img/ch18.png">

<p><b>4.27 Flue Gas Composition
</b></p>
<p>Refer to Problem 4.26. Determine the composition (by mole fraction) of the
product gas.<br>
Solution: The molar flow rates (output) were calculated previously:</p>

<img src="img/ch19.png"><br>
...
<div class="container">
    <a href="air_book1_lesson4.3.7.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.3.9.php" class="btn btn-primary">CONTINUE</a>
</div>
