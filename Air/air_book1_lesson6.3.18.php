...
<p><b>6.43 Dust Particle Resistivity</b></p>

<p>An electrostatic precipitator (see Chapter 10 for more details) is collecting dust
particles whose average surface area is equivalent to that of spheres of 1.0 mm
radius. The resistivity of the dust is too high for satisfactory operation and it is
desired to reduce the resistivity by adding a gas, known as a conditioning
agent, which will be adsorbed on the surface of the dust particle. The following
facts have been determined by experiment:<br>
1. The conditioning agent has a molecular weight of 60.6, and a molecular
diameter of 1 A˚ .<br>
2. The adsorption of a monolayer will bring the resistivity down to a satisfactory
level.<br>
3. The area void fraction in monolayer packing of the conditioning agent on the
dust particle is 0.09307.<br>
4. The particle has a specific gravity of 3.0.<br>
5. If CAP is the ratio by weight of adsorbate to adsorbent, and y, the mole fraction of the conditioning agent in the gas stream, then
</p>

<img src="img/sd58.png"><br>
<img src="img/sd59.png"><br>
...
<div class="container">
   <a href="air_book1_lesson6.3.17.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson6.3.19.php" class="btn btn-primary">CONTINUE</a>
</div>
