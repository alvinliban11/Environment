...
<p>Amagat’s law is similar to Dalton’s law. Instead of considering the total pressure to
be made up of partial pressures where each component occupies the total container
volume, Amagat considered the total volume to be made up of partial volumes in
which each component is at the total pressure. The definition of the partial volume is
therefore the volume occupied by a component gas alone at the same temperature and
pressure as the mixture:</p>

<img src="img/va.png">

<p>It is common in the air pollution control industry to describe low concentrations of
pollutants in gaseous mixtures in parts per million by volume (ppmv). Since partial volumes are proportional to mole fractions, it is only necessary to multiply the mole
fraction of the pollutant by 1 million to obtain the concentration in parts per million.
[For liquids and solids, parts per million (ppm) is also used to express concentration,
although it is usually on a mass (ppmv) basis rather than a volume basis. The terms
ppmv and ppmw are sometimes used to distinguish between the volume and mass
...
<div class="container">
    ...
    <a href="air_book1_lesson3.4.1.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson3.5.php" class="btn btn-primary">CONTINUE</a>
</div>
