...
<p><b>4.28 Extent of Reaction Balances
</b></p>




<p>In one step of the contact process for the production of sulfuric acid, sulfur
dioxide is oxidized to sulfer trioxide at high pressures in the presence of a
catalyst:
</p>
<img src="img/ch20.png">
<p>A mixture of 300 lbmol/min of sulfur dioxide and 400 lbmol/min of oxygen is fed to a reactor. The flow rate of the unreacted oxygen leaving the reactor is 300
lbmol/min. Determine the composition (in mol%) of the exiting gas stream by
three methods:<br>
(a) Molecular balances<br>
(b) Atomic balances<br>
(c) “Extent of reaction” balances<br>
Solution: As noted earlier, three different types of material balance may be
written when a chemical reaction is involved: the molecular balance, the
atomic balance, and the “extent of reaction” balance. It is a matter of convenience
which of the three types is used. Assuming a steady-state continuous reaction, the
accumulation term A is zero and, for all components involved in the reaction, the
molecular balance equation becomes</p>
<img src="img/ch21.png"><br>

<p>where:<br>

I = amount or rate of input<br>

G = amount or rate of material generated<br>

O = amount or rate of output<br>

C = amount or rate of material consumed<br>

If a total material balance is performed, the appropriate form of the balanced
equation must be used if the amounts of the flow rates are expressed in terms
of moles, e.g., lbmol or gmol/hr since the total number of moles can change
during a chemical reaction. If, however, the amounts or flow rates are given in
terms of mass, e.g., kg or lb/hr, the G and C terms may be dropped, since
mass cannot be lost or gained in a chemical reaction. Therefore</p>

<p class="indent1">I = O</p>

<p>In general, however, when a chemical reaction is involved, it is usually more convenient to express amounts and flow rates using moles rather than mass. A
material balance that is based not on the compounds (or molecules), but rather
on the atoms that make up the molecules, is referred to as an atomic balance.
Since atoms are neither created nor destroyed in a chemical reaction, the G and
C terms equal zero and the balance again becomes</p>

<p class="indent1">I = O</p>

<p>As an example, take once again the combination of hydrogen and oxygen to form
water:</p>

<img src="img/ch22.png">

<p>of oxygen atoms(or moles of oxygen atoms) and the number of hydrogen atoms
(or moles of hydrogen atoms) do not change. Care must also be taken to distinguish between molecular oxygen and atomic oxygen. If, in the preceding reaction, one starts out with 1000lbmol of O2 (oxygen molecules), one also starts out
with 2000lbmol of O (oxygen atoms). The extent of reaction balance gets its
name from the fact that the amounts of the chemicals involved in the reaction
are described in terms of how much of a particular reactant has been consumed
or how much of a particular product has been generated. As an example, consider
the formation of ammonia from hydrogen and nitrogen:</p>



<img src="img/ch13.png"><br>
...
<div class="container">
    <a href="air_book1_lesson4.3.8.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.3.10.php" class="btn btn-primary">CONTINUE</a>
</div>
