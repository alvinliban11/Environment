...
<div class="list-group">
 <span class="text-primary">Lessons</span>
  ...
  <a href="air_book1_introduction.php" class="list-group-item list-group-item-action" style=" border-left: 7px solid green;">INTRODUCTION</a>
...
<p>Proper selection of a particular system for a specific application can be extremely difficult and complicated. In view of the multitude of complex and often ambiguous
pollution control regulations, it is in the best interest of the prospective user (as noted
above) to work closely with regulatory officials as early as possible in the process.<br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
The final choice in equipment selection is usually dictated by that piece of equipment capable of achieving compliance with regulatory codes at the lowest uniform
...
effects—although important—are extremely difficult to quantify.</p>

<p class="indent">In order to compare specific control equipment alternatives, knowledge of the particular application and site is also essential. A preliminary screening, however, may be
...
sense, will simplify the selection process.</p>
...
<div class="container">
    <span class="text-success">Completed</span>
     <a href="air_book1_introduction1.2.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson1.php" class="btn btn-primary">CONTINUE TO LESSON 1</a>
</div>
