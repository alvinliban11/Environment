...
<p><b>6.37 Molecular Sieve Regeneration


</b></p>

<p> Use the graph in Figure 6.11 to solve the following problem. Estimate the pounds
of CO2 that can be adsorbed by 100 lb of Davison 4 A˚ molecular sieve from a
</p>

<img src="img/sd47.png">


<p>discharge gas mixture at 778F and 40 psia containing 10,000 ppmv (ppm by
volume) CO2.<br>
Solution: Calculate the mole fraction of CO2 in the discharge gas mixture:</p>

<img src="img/sd48.png">

<p><b>6.38</b></p>

<p>Refer to Problem 6.37. What percentage of this adsorbed vapor would be
recovered by passing superheated steam at a temperature of 3928F through the
adsorbent until the partial pressure of the CO2 in the stream leaving is reduced
to 1.0 mm Hg?<br>
Solution: Estimate the adsorbent capacity at 3928F and 1.0 mm Hg. Note that
this represents the HEEL:<br>
HEEL = 0:8 lb CO2=100 lb sieve</p>
<img src="img/sd49.png">

<p><b>6.39</b></p>

<p>Refer to Problem 6.37. What is the residual CO2 partial pressure in a gas mixture
at 778F in contact with the freshly stripped sieve in Problem 6.38.
Solution: Estimate the partial pressure of CO2 in mm Hg in equilibrium at 778F
with sieve containing 0.8 lb CO2/100 lb sieve (the HEEL)</p>
<img src="img/sd50.png">
...
<div class="container">
   <a href="air_book1_lesson6.3.14.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson6.3.16.php" class="btn btn-primary">CONTINUE</a>
</div>
