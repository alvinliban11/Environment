...
<div class="dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="air_book1_lesson3.1.php" style=" border-left: 7px solid green;">Lesson 3.1</a>
...
<div class="container">
    <h2>LESSON 3.1 INTRODUCTION</h2>


<p>This chapter provides a review of some basic concepts from physics, chemistry, and
engineering in preparation for material that is covered in later chapters. These basic concepts include units and dimensions, some physical and chemical properties of substances, the ideal gas law, the Reynolds number, and phase equilibria. Because many
of these topics are unrelated to each other, this chapter admittedly lacks the cohesiveness
that chapters covering a single topic might have. This is usually the case when basic
material from such widely differing areas of knowledge as physics, chemistry, and
engineering is surveyed. Although these topics are widely divergent and covered with
varying degrees of thoroughness, all of them will find later use in this book.</p>
...
<div class="container">
    <span class="text-success">Completed</span>
      <a href="air_book1_lesson2.6.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson3.2.php" class="btn btn-primary">CONTINUE</a>
</div>
