...
<p><b>4.35 Calculations for Natural Gas Combustion
</b></p>

<p>As an air pollution control engineer you have been requested to evaluate the
gross heating value of a natural gas of a given composition. You are also to determine the available heat of the natural gas at a given temperature, the rate of
auxiliary fuel (natural gas) required to heat a known amount of contaminated
air to a given temperature, the dimensions of an afterburner treating the contaminated air stream, and the residence time. Operating and pertinent design data are
provided in Table 4.4. The natural gas composition (mole or volume fraction) is
identical to that provided in Problem 4.33. See also Table 4.3.<br><br>

Gas velocity ¼ 20ft/s<br>
Length-to-diameter ratio of the afterburner ¼ 2.0<br>
Temperature of dry natural gas ¼ 608F<br>
Volumetric flow rate of contaminated air ¼ 5000 scfm (608F, 1 atm)<br>
Molar enthalpy data are provided in Table 4.5.<br><br>
It is required to heat the contaminated air from 2008F to 12008F.

</p>
<img src="img/ch40.png"><br>


<p>The balanced chemical combustion equations for each of the four components of
the natural gas using 1 scf of natural gas as a basis is</p>


&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img src="img/ch41.png"><br>


<img src="img/ch42.png"><br>
...
<div class="container">
   <a href="air_book1_lesson4.3.14.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.3.16.php" class="btn btn-primary">CONTINUE</a>
</div>
