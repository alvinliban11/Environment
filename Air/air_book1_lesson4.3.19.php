...
<p><b>4.39 Plan Review of a Direct Flame Afterburner
</b></p>

<p>A regulatory agency engineer must review plans for a permit to construct a direct
flame afterburner (Figure 4.8) serving a lithographer. Review is for the purpose
of judging whether the proposed system, when operating as it is designed to
operate, will meet emission standards. The permit application provides operating
and design data. Agency experience has established design criteria that, if met in
</p>
<img src="img/ch53.png">
<p>an operating system, will typically ensure compliance with standards. Operating
data from the permit application are provided below.</p>

<img src="img/ch54.png">

<p>Solution: The design temperature is already within agency criteria. To determine
the fuel requirement for the afterburner, first calculate the total heat load (heating rate) Q˙ required to raise 7000scfm of the effluent stream from 7388F to
14008F in Btu/min:</p>

<img src="img/ch55.png"><br>
<img src="img/ch56.png">
</ol>

</div>

<div class="container">
   <a href="air_book1_lesson4.3.18.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.3.20.php" class="btn btn-primary">CONTINUE</a>
</div>
