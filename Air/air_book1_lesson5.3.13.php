...
<p><b>5.37 Estimation of Liquid Rate and Inlet Concentration
</b></p>



<p>A packed tower is employed on an air stream containing NH3. The operating
and design data are given below. Use Figure 5.11 to estimate the liquid rate in
lb/hr . ft2 and Figure 5.6 (or the corresponding equation) to calculate the inlet
NH3 gas composition (mol%):
</p>


<p class="indent">Packed column height = 8.5 ft


</p>
<p class="indent">Packing type A (see Figure 5.11)



</p>
<p class="indent">HOG = 2.6 ft



</p>
<p class="indent">Outlet NH3 gas composition = 0.3 mol%



</p>
<p class="indent">Henry’s law constant = 0.95



</p>
<p class="indent">Molecular weight of air = 29 lb/lbmol



</p>
<p class="indent">Molecular weight of water = 18 lb/lbmol



</p>
<p class="indent">Gas flow rate = 2000 acfm

</p>
<p class="indent">Tower diameter = 4.04 ft

<img src="img/aw36.png"><br>
<img src="img/aw37.png">



<p><b>5.38 Sizing of a Packed Tower with No Data
</b></p>


<p>Qualitatively outline how one can size (diameter, height) a packed tower to
achieve a given degree of separation without any information on the physical
and chemical properties of a gas to be cleaned.<br><br>
Solution: To calculate the height, one needs both the height of a gas transfer unit
HOG and the number of gas transfer units NOG. Since equilibrium data are not
available, assume that m (slope of equilibrium curve) approaches zero. This is
not an unreasonable assumption for most solvents that preferentially absorb
(or react with) the solute. For this condition:
</p>

<img src="img/aw38.png">


<p>where y1 and y2 represent inlet and outlet concentrations, respectively. Since it is
reasonable to assume the scrubbing medium to be water or a solvent that effectively has the physical and chemical properties of water, HOG can be assigned
values usually encountered for water systems. These are given in Table 5.4.
For plastic packing, the liquid and gas flow rates are both typically in the</p>
...
<div class="container">
   <a href="air_book1_lesson5.3.12.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson5.3.14.php" class="btn btn-primary">CONTINUE</a>
</div>
