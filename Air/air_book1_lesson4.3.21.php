...
<p><b>4.41 Catalyst Sizing


</b></p>

<p>Refer to Problem 4.40. Is the catalyst section property sized?
Solution: To determine whether the catalyst section is sized properly, first
calculate the volume rate of flue products at 10008F from the combustion of
the natural gas:
</p>

<img src="img/ch59.png">

<p>This comprises favorably with the data sheet value of 6350 acfm. Calculate the
number of 19  24  3.75inch catalyst elements N required. Employ a velocity
of 600 ft/min.</p>

<img src="img/ch60.png">

<p>The catalyst section is sized properly. It is seen that four elements have been
specified; this is a conservative design allowing a slightly slower gas flow
through the elements. With four elements, the superficial velocity is reduced
to 8.6ft/s. This too is in agreement with the design specification.
</p>
...
<div class="container">
   <a href="air_book1_lesson4.3.20.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.3.22.php" class="btn btn-primary">CONTINUE</a>
</div>
