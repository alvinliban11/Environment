...
<img src="img/ch11.png">


<p><b>4.23 Products of Complete Combustion


</b></p>
<p>Determine the products of complete combustion when burning a gaseous fuel of
the following composition with 50% excess air: N2 = 0.15, CH4 = 0.81,
C3H8 = 0.04. Perform the calculations assuming a volumetric flow rate of the
fuel of 1.0 scfm. <br>
Solution: Write the balanced chemical equations for complete combustion:</p>


<img src="img/ch12.png">
...
<div class="container">
    <a href="air_book1_lesson4.3.5.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.3.7.php" class="btn btn-primary">CONTINUE</a>
</div>
