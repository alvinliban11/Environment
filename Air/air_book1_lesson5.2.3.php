...
<img src="img/yx10.png">


<p>where the absorption factor is A (not to be confused with area) and is equal to L/mG where
m is the slope of the equilibrium curve. The solution to this equation can conveniently
be found graphically from Figure 5.6. Note also that the flow rates L and G are based
on moles in Equation (5.12). However, if m ¼ 0, Equation (5.12) reduces to
</p>
<img src="img/yx11.png">


<p>This equation may be applied if the gas is highly soluble or if the absorbate (pollutant)
reacts with the liquid (L. Theodore: personal notes, 1976).<br><br>
Qualitatively, the height of a transfer unit is a measure of the height of a contactor
required to effect a standard separation, and it is a function of the gas flow rate, the liquid
flow rate, the type of packing, and the chemistry of the system. As indicated above,
experimental values for NOG are generally available in the literature or from vendors.</p>




<p class="indent">Some general rules of thumb in the design of packed columns do exist. They are by
no means all-inclusive in that there are other considerations that might have to be taken
into account, e.g., allowable pressure drop, possible column height restrictions, etc. The
rules must therefore be applied discriminately. For approximation purposes, if the gas
rate is greater than about 500 acfm, a nominal packing size smaller than 1inch would
probably not be practical; similarly, at about 2000 acfm, packing sizes smaller than
2 inch would also likely be impractical. The nominal size of the packing should never
exceed about 1/20th of the column diameter.
</p>


<p>As noted earlier, the usual practice is to design so that the operational gas rate is
approximately 75% of the rate that would cause flooding. If possible, column dimensions should be in readily available sizes (i.e., diameters to the nearest half-foot and
heights to the nearest foot). If the column can be purchased “off the shelf” as
opposed to being specially made, a substantial savings can be realized.</p>

<h4>Plate Column
</h4>

<p>The most important design considerations for plate columns include calculation of the
column diameter, type and number of plates to be used (usually sieve plates), actual
plate layout and physical design, and plate spacing (which, in turn, determines the
column height). To consider each of these to any great extent is beyond the scope of
this book. Details are available in any standard chemical engineering unit operations
or mass transfer (e.g., distillation) text. The discussion that follows, therefore, will be
a relatively concise presentation of the general design techniques that will provide satisfactory results for the purpose of estimation.</p>

<p>The column diameter and consequently its cross section must be sufficiently large
to handle the gas and liquid at velocities that will not cause flooding or excessive entrainment. The superficial gas velocity for a given type of plate at flooding is given by
the relation</p>

<img src="img/yx12.png">
</ol>

</div>

<div class="container">
   <a href="air_book1_lesson5.2.2.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson5.2.4.php" class="btn btn-primary">CONTINUE</a>
</div>
