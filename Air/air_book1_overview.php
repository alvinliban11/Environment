...
<div class="list-group">
 <span class="text-primary">Lessons</span>
  <a href="air_book1_overview.php" class="list-group-item list-group-item-action" style=" border-left: 7px solid green;">AIR POLLUTION CONTROL EQUIPMENT CALCULATIONS OVERVIEW</a>
...
<p>Welcome to Air. In addition to the course modules, we&#39;ve included some additional course materials.</p>
...
<div class="container">
    ...
    <a href="air_book1_introduction.php" class="btn btn-primary">Introduction</a>
</div>
