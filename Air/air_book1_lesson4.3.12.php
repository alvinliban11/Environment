...
<p><b>4.30 Outlet Temperature Calculation
</b></p>




<p>Given the following information, determine the outlet temperature of the
incinerator:</p>
<img src="img/ch32.png"><br>
<img src="img/ch33.png">

<p><b>4.31 Heat Transfer Requirement
</b></p>

<p>Given 10,000scfm (608F, 1 atm) of butanol-contaminated air heated from
3008F to 15008F, find the heat transfer required to bring about this change of
temperature. The enthalpy values of air at 3008F and 15008F are 1870 and
10,895Btu/lbmol, respectively.<br>
Solution: The molar flow rate is</p>
<img src="img/ch34.png"><br>
...
<div class="container">
   <a href="air_book1_lesson4.3.11.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.3.13.php" class="btn btn-primary">CONTINUE</a>
</div>
