...
<img src="img/aw39.png">

<p>range of 1500–2000 lb/(hr . ft2
) of cross-sectional area. (Note: The “flow rates”
are more properly termed “fluxes”; a flux is a flow rate per unit crosssectional area with units of lb/hr . ft2 in this problem. However, it is common
practice to use the term rate.) For ceramic packing, the range of flow rates is
500–1000 lb/hr . ft2
. For difficult-to-absorb gases, the gas flow rate is usually
lower and the liquid flow rate higher. Superficial gas velocities (velocity of the
gas if the column is empty) are in the 3–6-ft/s range. The height Z is then
calculated from</p>
<img src="img/aw40.png">

<p>where SF is a safety factor, the value of which can range from 1.25 to 1.5.
Pressure drops can vary from 0.15 to 0.40 inch H2O/ft packing. Packing size
increases with increasing tower diameter. (Note: This problem and design
procedure were originally developed by Dr. Louis Theodore in 1985 and later
published in 1988. These materials have appeared elsewhere without
properly acknowledging the author, and without permission from the original
publisher.) The reader is left the exercise of verifying the chart in Table 5.5
for plastic packing.</p>
<img src="img/aw41.png">
...
<p><b>5.39 Packed Tower Absorber Design with No Data
</b></p>



<p>A 1600 acfm gas stream is to be treated in a packed tower containing ceramic
packing. The gas stream contains 100 ppm of a toxic pollutant that is to be
reduced to 1ppm. Estimate the tower’s cross-sectional area, diameter, height,
pressure drop, and packing size. Use the procedure outlined in Problem 5.38.<br><br>
Solution: Key information from Problem 5.38 for ceramic packing is provided in
Table 5.6. The equation for the cross-sectional area of the tower S in terms of the
gas volumetric flow rate q in acfs is
</p>

<img src="img/aw42.png">

<p>For a tower this large, the 3.5-inch packing should be used. Additional information is available from L. Theodore, “Engineering Calculations: Sizing
Packed-Tower Absorber without Data,” Chem. Eng. Progress, p. 18, May 2005.</p>
...
<div class="container">
   <a href="air_book1_lesson5.3.13.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson5.3.15.php" class="btn btn-primary">CONTINUE</a>
</div>
