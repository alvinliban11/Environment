...
<p><b>3.22 Reynolds Number
</b></p>

<p>The Reynolds number (Re)<br>
(a) Describes fluid flow and is equal to mCp/rDQ<br>
(b) Equals 6.02  1023<br>
(c) Describes how a fluid behaves while flowing and is defined as the inertial<br>
forces divided by the viscous forces (Dvr/m)<br>
(d) Is generally used only for liquids<br>
Solution: Answers (a), (b), and (d) are obviously incorrect. The definition of Re
is given in Equation (3.13). The correct answer is therefore (c).</p>

<p><b>3.23 Reynolds Number Calculation
</b></p>


<p>Calculate the Reynolds number for a gas flowing through a 5-inch-diameter
pipe at 10 fps (feet per second) with a density of 0.050 lb/ft3 and a viscosity
of 0.065 cP? Is the flow turbulent or laminar?<br>
...
<p>The Reynolds number is >2100; therefore, this gas flow is turbulent. Generally,
moving gases are in the turbulent flow regime.</p>


<p><b>3.24 Process Calculation
</b></p>




<p >An external gas stream is fed into an air pollution control device at a rate of
...
= rate of mass accumulated</p>

<p>Note that mass is not generated and steady conditions (no accumulation) apply.
Rewrite this equation subject to the conditions in the problem statement.<br>
Rate of mass in = rate of mass out
or</p>


<img src="img/inin.png"><br>
<img src="img/inin2.png">

<p>As noted earlier, the conservation law for mass may be written for any
...
unknown quantities in a particular problem situation.</p>
...
<div class="container">
    <a href="air_book1_lesson3.6.7.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson3.6.9.php" class="btn btn-primary">CONTINUE</a>
</div>
