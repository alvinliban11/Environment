...
<div class="dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <a class="dropdown-item" href="air_book1_lesson4.2.php" style=" border-left: 7px solid green;">Lesson 4.2</a>
...
<div class="container">
    <h2>LESSON 4.2 DESIGN AND PERFORMANCE EQUATIONS
</h2><br>


<p>In describing any combustion process, there are numerous terms used to define heat.
These terms can be split into two categories: combustion and thermodynamic.
Combustion terms are included to aid in standardizing fuel usage calculations; these
terms are applied to heat that is produced by combustion methods. Thermodynamic
terms apply to all systems. Since the combustion terms are specific examples of the thermodynamic terms, some overlap is involved in defining them.
</p>

<p class="indent">The following are important terms describing heat thermodynamically:</p>

<p class="indent">1. Heat content or enthalpy (H)—the sum total of latent and sensible heat present in a
substance (gas, liquid or solid) minus that contained at an arbitrary set of conditions
chosen as the base or zero point. Values for various gases are listed in Table 4.1.</p>

<p class="indent">2. Sensible heat (Hs)—heat that when added or removed causes a change in
temperature.</p>

<p class="indent">3. Latent heat (Hl)—heat given off by a vapor condensing to a liquid or gained by a
liquid evaporating to a vapor, without a change in temperature. The latent heat of
vaporization of water 2128F is 970.3 Btu/lb.</p>

<p>Some useful terms describing the heat produced by the combustion of a fuel are:
</p>

<p class="indent">1. Gross heating value (HVG)—the total heat obtained from the complete combustion of a fuel at 608F. Constant pressure, normally 1 atm, is maintained throughout the entire combustion process. Gross heating values are also referred to as
total or higher heating values (HHV).</p>

<p class="indent">2. Net heat value (HVN)—the gross heating value minus the latent heat of
vaporization of the water formed by the combustion of the hydrogen in the
fuel. For a fuel containing no hydrogen, the net and gross heating values
are the same. Net heating values are also referred to as the lower heating
values (LHV).</p>

<img src="img/heat.png">

<p class="indent">3. Available heat (HA)—the gross quantity of heat released within a combustion
chamber minus (1) the sensible heat carried away by the dry flue gases and
(2) the latent heat and sensible heat carried away in water vapor contained in
the flue gases. The available heat represents the net quantity of heat remaining
for useful heating. Figure 4.5 shows the available heat from the complete combustion (no excess air) of various fuels at various flue gas temperatures.</p>
...
<div class="container">
    <a href="air_book1_lesson4.1.5.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.2.1.php" class="btn btn-primary">CONTINUE</a>
</div>
