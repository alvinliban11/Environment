...
<p><b>4.18 Butanol Combustion


</b></p>

<p>The offensive odor of butanol can be removed from stack gases by its complete
combustion to carbon dioxide and water. It is of interest that the incomplete
combustion of butanol actually results in a more serious odor pollution
problem than the original one. Write the equations showing the two intermediate
malodorous products formed if butanol undergoes incomplete combustion.<br>
Solution: The malodorous products are butyraldehde (C4H8O) and butyric acid
(C3H7COOH), which can be formed sequentically as follows:
</p>

<img src="img/ch7.png">


<p><b>4.19 Butyl Alcohol Combustion
</b></p>
<p>Calculate the volume of air required to combust one pound of butyl alcohol at
60ºF and 1 atm to<br>
(a) Butylaldehyde<br>
(b) Butyric acid<br>
(c) Carbon dioxide and water<br>
Solution: The chemical formula for butyl alcohol is C4H9OH; it has a molecular
weight of 74. The number of moles of one pound of alcohol is</p>
...
<div class="container">
    <a href="air_book1_lesson4.3.3.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.3.5.php" class="btn btn-primary">CONTINUE</a>
</div>
