...
<p><b>4.36 Available Heat and Fuel Flow Rate

</b></p>

<p>A process gas stream (assume air) of 1.75  106
acfm at 328F and 1 atm is to be
incinerated at 19008F in a process boiler that is 30 ft 30 ft 40ft. Natural gas
(assume reference) is to be employed with stoichiometric (primary) air. The stoichiometric combustion of natural gas produces 11.4mol of flue gas per mole of
natural gas. Find the available heat in Btu/min and calculate the required natural
gas flow rate in scfm (608F, 1atm).<br>
Solution: The molar flow rate and enthalpy change are first calculated. Note once
again that one lbmol of an ideal gas occupies 359ft3 at 328F and 1atm:

</p>
<img src="img/ch48.png"><br>
<img src="img/ch49.png">


<p><b>4.37 Required Residence Time
</b></p>

<p>Refer to Problem 4.36. Does the unit meet the required residence time of 0.7s?<br>
Solution: The volume of the system is
</p>

<img src="img/ch50.png">
</ol>

</div>

<div class="container">
   <a href="air_book1_lesson4.3.16.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.3.18.php" class="btn btn-primary">CONTINUE</a>
</div>
