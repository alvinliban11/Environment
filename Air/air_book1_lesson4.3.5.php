...
<p><b>4.20 Ethanol Combustion


</b></p>

<p>When ethanol (C2H5OH) is completely combusted, the products are carbon
dioxide and water.<br>
(a) Write the balanced reaction equation.<br>
(b) If 150 lbmol/hr of water is produced, at what rate (molar) is the ethanol
combusted?<br>
(c) If 2000 kg of the ethanol is combusted, what mass of oxygen is required?<br>
...
<p><b>4.21 Limiting Reactant I

</b></p>
<p>Complete combustion of carbon disulfide results in combustion products of CO2
and SO2 according to the reaction</p>
<p class="indent1">CS2 + O2 + CO2 + SO2</p>
<p>(a) Balance this reaction equation.<br>
(b) If 500 lb of CS2 is combusted with 225 lb of oxygen, which is the limiting
reactant?</p>

<img src="img/ch10.png">
...
<div class="container">
    <a href="air_book1_lesson4.3.4.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.3.6.php" class="btn btn-primary">CONTINUE</a>
</div>
