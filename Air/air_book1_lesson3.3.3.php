...
<p>The Reynolds number (Re) is a dimensionless number that indicates whether a fluid
flowing is in the laminar or turbulent regime. Laminar flow is characteristic of fluids
flowing slow enough so that there are no eddies (whirlpools) or macroscopic mixing
of different portions of the fluid. (Note: In any fluid, there is always molecular
mixing due to the thermal activity of the molecules; this is distinct from macroscopic
mixing due to the swirling motion of different portions of the fluid.) In laminar flow,
a fluid can be imagined to flow like a deck of cards, with adjacent layers sliding past
one another. Turbulent flow is characterized by eddies and macroscopic currents. In
practice, moving gases are generally in the turbulent region. For flow in a pipe, a
Reynolds number above 2100 is an indication of turbulent flow.</p>

<p>The Reynolds number is dependent on the fluid velocity, density, viscosity, and
some characteristic length of the system or conduit; for pipes, the characteristic length
is the inside diameter, and for particles it is the particle diameter:</p>

<img src="img/reynolds.png">

<p><b>pH</b></p>
<p>An important chemical property of an aqueous solution is its pH. The pH measures the
acidity or basicity of the solution. In a neutral solution, such as pure water, the hydrogen
(Hþ) and hydroxyl (OH2) ion concentrations are equal. At ordinary temperatures, this
concentration is</p>

<img src="img/ph.png">

<p>The unit g . ion stands for gram.ion, which represents an Avogadro number of ions. In
all aqueous solutions, whether neutral, basic, or acidic, a chemical equilibrium or
balance is established between these two concentrations, so that</p>

<img src="img/kq.png">

<p><b>Boiling and Freezing Points</b></p>

<p>The boiling point is the temperature at which the vapor pressure of a liquid is equal to its
surrounding pressure. Since the vapor pressure remains constant during boiling, so does
the temperature. The higher the system pressure, the higher the temperature must be to
induce boiling. The boiling point is specific to each individual substance and is a strong
function of pressure. The freezing point is the temperature at which the liquid and solid
state of a substance coexist in equilibrium at a given pressure. At this point the rate
at which the substance leaves the solid state equals the rate at which it leaves the
liquid state.</p>

<p><b>Vapor Pressure</b></p>


<p>This section concludes with a discussion of vapor pressure (denoted p0
), which is an
important property of liquids, and, to a much lesser extent, of solids. If a liquid is
allowed to evaporate in a confined space, the pressure in the vapor space increases as
the amount of vapor increases. If there is sufficient liquid present, a point is eventually
reached at which the pressure in the vapor space is exactly equal to the pressure exerted
by the liquid at its own surface. At this point, a dynamic equilibrium exists in which
vaporization and condensation take place at equal rates and the pressure in the vapor
space remains constant. The pressure exerted at equilibrium is called the vapor pressure
of the liquid. The magnitude of this pressure for a given liquid depends on the temperature, but not on the amount of liquid present. Solids, like liquids, also exert a vapor
pressure. Evaporation of solids (called sublimation) is noticeable only for those solids
with appreciable vapor pressures.
</p>
...
<div class="container">
    <span class="text-success">Completed</span>
     <a href="air_book1_lesson3.3.2.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson3.4.php" class="btn btn-primary">CONTINUE</a>
</div>
