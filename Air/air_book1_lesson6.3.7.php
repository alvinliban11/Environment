...
<p><b>6.22 Adsorber Column Height


</b></p>

<p>Determine the required height of adsorbent for an adsorber that treats a degreaser
ventilation stream contaminated with trichloroethylene (TCE) given the following operating and design data:<br>
Volumetric flow rate of contaminated air stream = 10,000 scfm<br>
Standard conditions = 608F, 1 atm<br>
Operating temperature =708F<br>
Operating pressure = 20 psia<br>
Adsorbent = activated carbon<br>
Bulk density of activated carbon, rB = 36 lb/ft3<br>
Working capacity of activated carbon = 28 lb TCE/100 lb carbon<br>
Inlet concentration of TCE = 2000 ppm (ppm by volume)<br>
Molecular weight of TCE = 131.5<br>
The adsorption column cycle is set at 4 hr in the adsorption mode, 2 hr in heating
and desorbing, 1 hr in cooling, and 1 hr in standby. The adsorber recovers 99.5%
by weight of TCE. A horizontal cylinder unit with an inside diameter of 6 ft and
length of 15 ft is used. Employ the design procedure provided in Section 6.2.<br>
Solution: The actual volumetric flow rate of the contaminated gas stream q in
acfh (actual cubic feet per hour) is obtained using Charles’ Law:
</p>

<img src="img/sd18.png"><br>
<img src="img/sd19.png">




<p><b>6.23 Calculation of Bed Volume and Height
...
<p>Calculation of Bed Volume and Height
Theodore Consultants has been selected by Fitzmaurice Chemicals Inc., to
design an adsorber which treats a degreaser ventilation stream contaminated
with trichloroethylene (TCE). Fitzmaurice Chemicals has provided basic operating data to Theodore Consultants that requires the use of activated carbon as an
adsorbent. Determine the volume of activated carbon required to treat the gas and
the height of the adsorption column. Operating data are provided below:<br>
Flow rate of contaminated air stream = 12,000 scfm<br>
Standard conditions = 1atm, 658F<br>
Operating conditions = 25 psia and 758F<br>
Bulk density of activated carbon = 38 lb/ft3<br>
Working capacity of activated carbon = 25 lb TCE per 100 lb carbon<br>
Inlet concentration of TCE = 2000 ppmv<br><br>
The adsorption column cycle is set at 5 hr in the adsorption mode, 2 hr in
heating–desorbing mode, 2 hr in cooling, and 1 hr in standby. The adsorber
recovers 96% of TCE by weight. A horizontal unit with a 5 ft  20 ft crosssectional area is recommended.</p>

<img src="img/sd20.png">
...
<div class="container">
   <a href="air_book1_lesson6.3.6.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson6.3.8.php" class="btn btn-primary">CONTINUE</a>
</div>
