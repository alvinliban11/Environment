...
<p>The following are some helpful points on the use of psychrometric charts:
</p>


<p>1. In problems involving the use of the humidity chart, it is convenient to choose
a mass of dry air as a basis since the chart uses this basis</p>

<p>2. Heating or cooling at temperatures above the dew point (temperature at which
the vapor begins to condense) corresponds to a horizontal movement on the chart. As long as no condensation occurs, the absolute humidity stays
constant.
</p>


<p><b>3.34 Saturated Water Discharge
</b></p>


<p>A flue gas is discharged at 1208F from an HCl absorber in a hazardous waste
incinerator (HWI) facility in which carbon tetrachloride (CCl4) is being incinerated. If 9000 lb/hr (MW ¼ 30) of gas enters the absorber essentially dry (negligible water) at 5608F, calculate the moisture content, the mass flow rate, and the
volumetric flow rate of the discharged gas. The discharge gas from the absorber
may safely be assumed to be saturated with water vapor. The discharge humidity
of the flue gas is approximately.</p>



<img src="img/hout.png">

<p>Solution: The Hout represents the moisture content of the gas at outlet conditions
in lb H2O/lb dry air. If the gas is assumed to have the properties of air, the discharge water vapor rate is</p>

<img src="img/inho.png">

<p>The volumetric (or molar) flow rate can be calculated only if the molecular
...
<img src="img/9000.png"><br>
<img src="img/90001.png">
...
<div class="container">
    ...
    <a href="air_book1_lesson3.6.12.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.1.php" class="btn btn-primary">CONTINUE</a>
</div>
