...
<p>The equilibrium of interest in gas absorption operations is that between a relatively nonvolatile absorbing liquid (solvent) and solute gas (usually the pollutant). As described
earlier, the solute is ordinarily removed from a relatively large amount of a carrier gas
that does not dissolve in the absorbing liquid. The equilibrium relationship of importance
is a plot (or data) of x, the mole fraction of solute in the liquid, against y (sometimes
denoted simply as y), the mole fraction in the vapor in equilibrium with x. For cases
that follow Henry’s law, Henry’s law constant m can be defined by the equation
</p>

<img src="img/yx.png">

<p class="indent">The usual operating data to be determined or estimated for isothermal systems are
the liquid rate(s) and the terminal concentrations or mole fractions. An operating line
that describes operating conditions in the column is obtained by a mass balance
around the column (as shown in Figure 5.3)</p>

<img src="img/yx1.png">



<p class="indent">The terms G and L represent the molar flow rates of the gas and liquid, respectively.
For component A, the mole (or mass) balance becomes
</p>

<img src="img/yx2.png">


<p class="indent">Assuming Gm1 ¼ Gm2 and Lm1 ¼ Lm2 (reasonable for most air pollution control application where contaminant concentrations are usually extremely small), one may write
Equation (5.3) as</p>

<img src="img/yx3.png"><br>
<img src="img/yx3.png">

<p class="indent">This is the equation of a straight line known as the operating line since it describes operating conditions in the column. On x, y coordinates, it has a slope of Lm/Gm and passes
through the points (xA1, yA1) and (xA2, yA2) as indicated in Figure 5.4.
</p>


<img src="img/yx4.png">

<p>This is the equation of a straight line known as the operating line since it describes operating conditions in the column. On x, y coordinates, it has a slope of Lm/Gm and passes
through the points (xA1, yA1) and (xA2, yA2) as indicated in Figure 5.4.<br>
In the design of most absorption columns, the quantity of gas to be treated Gm, the
terminal concentrations yA1 and yA2, and the composition of the entering liquid xA2 are
ordinarily fixed by process requirements; however, the quantity of liquid solvent to
be used is subject to some choice. Should this quantity already be specified, the</p>
...
<div class="container">
   <a href="air_book1_lesson5.1.1.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson5.2.1.php" class="btn btn-primary">CONTINUE</a>
</div>
