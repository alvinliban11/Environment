...
<div class="dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <a class="dropdown-item" href="air_book1_lesson7.3.php">Lesson 7.3</a>
     <a class="dropdown-item" href="air_book1_lesson7.4.php" style=" border-left: 7px solid green;">Lesson 7.4</a>
...
<div class="container">
 ...
 <h2>7.4 PARTICLE SIZING AND MEASUREMENT METHODS
...
<p>Note that particles that appear to be different in physical size and shape can have the
same aerodynamic diameter. Conversely, some particles that appear to be visually
similar can have somewhat different aerodynamic diameters. Thus, the term aerodynamic diameter is useful in describing all particles, including fibers and particle clusters.
Although it is not a true size because nonspherical particles require more than one
dimension to characterize their size, the aerodynamic diameter provides a simple
means of categorizing the sizes of particles with a single dimension and in a way that
relates to how particles move in a fluid.</p>

<p class="indent">An accurate quantitative analysis of the discharge of particulates from a process
must be determined prior to the design and/or selection of recovery/control equipment.
If the unit is properly engineered, utilizing the emission data as input to the device, most
particulates can be successfully controlled by one or a combination of the methods to be
discussed later in this book.</p>




<p class="indent">If one were able to design an ideal particle measuring device, the device should be able to:<br>
1. Measure the exact size of each particle<br>
2. Report data instantaneously without averaging data over some specified time
interval<br>
3. Determine the composition of each particle including shape, density, chemical
nature, and so on
</p>
...
<p class="indent">It would be an extremely difficult task to produce such an instrument. At this time there
are devices that incorporate only one or two of these ideal functions. Various sizing techniques are listed below. Details are available in the literature (L. Theodore,
Nanotechnology: Basic Calculations For Engineers and Scientists, John Wiley &
Sons, Hoboken, NJ, 2007).
</p>

<p class="indent">1. Microscopy
...
<p class="indent">2. Optical counters</p>
<p class="indent">3. Electrical aerosol analyzers</p>
<p class="indent">4. Bahco microparticle classifier</p>
<p class="indent">5. Impactors</p>
<p class="indent">6. Photon correlation spectroscopy (PCS)</p>
...
<div class="container">
   <a href="air_book1_lesson7.4.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson7.5.php" class="btn btn-primary">CONTINUE</a>
</div>
