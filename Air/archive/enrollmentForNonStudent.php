...
<form action="#">
    <div class="container">
        <h3>ENROLLMENT FORM FOR NON-STUDENT</h3>        
        <div class="row">
            ...
            <div class="form-group">
                    Work:<input class="form-control" type="text" placeholder="Work"> 
                </div>
            <div class="form-group">
                    Work Address:<input class="form-control" type="text" placeholder="Work Adress"> 
                </div>
