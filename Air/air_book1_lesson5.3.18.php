...
<p><b>5.46 Economic Equation Applicability

</b></p>



<p>On the basis of the results of Problems 5.44 and 5.45, comment on the applicability of the (E, DP) equation.<br>
Solution: The results seem reasonable, as can be seen by plotting PR versus
either DP or E. This plot is provided in Figure 5.14.
</p>

<img src="img/aw56.png">


<p><b>5.47 Enthalpy of Solution Effects
</b></p>
...
<p>In an attempt to quantify the effect of enthalpy of solution effects on the absorption of HCl into scrubbing water in an absorber, Pallechi Consultants reviewed
the literature (personal notes: L. Theodore, 2006) and obtained the following
rough estimates of this effect. The data provided temperature increases as a function of increasing HCl concentration (mass percent basis) in water:
</p>
<img src="img/aw57.png">

<p>Apply the above data and estimate the discharge temperature increase for the
following three HCl scenarios:</p>
<p class="indent">Scenario 1: 0.0% inlet to 1.5% outlet
</p>
<p class="indent">Scenario 2: 0.5% inlet to 3.0% outlet
</p>
<p class="indent">Scenario 3: 0.5% inlet to 5.0% outlet
</p>

<p>Solution: Since enthalpy is a point function, it is reasonable to assume that the
temperature effects are additive. Therefore, the temperature increases are</p>
<img src="img/aw58.png">

<p>The reader should note that this is an effect that often should be reflected in engineering applications since any increase in the temperature of the scrubbing liquid
adversely affects the equilibrium, reducing the equilibrium capacity of the liquid.</p>


<p><b>5.48 Absorber Failure to Meet Performance Guarantee
</b></p>

<p>Consider the absorber system shown in Figure 5.15. Corenza Engineers designed
the unit to operate with a maximum discharge concentration of 50 ppm. Once the
unit was installed and running, the unit operated with a discharge of 60 ppm.
Rather than purchase a new unit, what options are available to bring the unit
into compliance with the specified design concentration?<br><br>
Solution: This is obviously an open-ended question. On the basis of the material
presented earlier in Section 5.1 and the solutions to several of the problems in
this chapter, one may employ any one or a combination of the following suggestions (L. Theodore: personal notes, 1986):<br><br>
1. Increase the temperature
2. Decrease the pressure</p>

<img src="img/aw59.png">

<p>3. Increase the height of the packing<br>
4. Place sprays at the inlet before the packing<br>
5. Increase the liquid flow rate, but check the pressure drop increase and any
potential effect on the fan<br>
6. Change the liquid, but check the pressure drop increase and any potential
effect on the fan<br>
7. Change packing size and/or type, but check the pressure drop increase and
any potential effect on the fan<br>
8. Process modification: reduce inlet pollutant concentration<br>
9. Process modification: reduce gas flow rate<br>
10. Design a new system<br>
11. Add more packing on top of existing packing (if possible), but check the
pressure drop increase and any potential effect on the fan<br>
12. Fire the design engineer<br>
13. Take the regulatory official/inspector out to lunch<br>
14. Shut down the plant<br><br>
Any other suggestions?<br><br>
NOTE: Additional problems are available for all readers at www.wiley.com.
Follow links for this title.</p>
...
<div class="container">
   <a href="air_book1_lesson5.3.17.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson6.1.php" class="btn btn-primary">CONTINUE</a>
</div>
