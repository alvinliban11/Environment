...
<p><b>5.23 Absorption Equilibria

</b></p>

<p>Experimental data are provided for an absorption system to be used for scrubbing
ammonia (NH3) from air with water. The water rate is 300 lb/min and the gas
rate is 250 lb/min at 728F. The applicable equilibrium data for the ammoniaair system is shown in Table 5.1(a) (R. H. Perry and D. W. Green, eds,
Perry’s Chemical Engineers’ Handbook, 7th ed. McGraw-Hill, New York,
</p>

<img src="img/aw7.png">

<p>1996). The air to be scrubbed has 1.5% (mass basis) NH3 at 728F and 1 atm
pressure and is to be vented with 95% of the ammonia removed. The inlet scrubber water is ammonia-free</p>

<p>(a) Plot the equilibrium data in mole fraction units.<br>
(b) Perform the material balance and plot the operating line on the equilibrium
plot.<br>
Solution:<br> (a) Employing the data provided in the problem statement, convert the
equilibrium partial pressure data and the liquid concentration data to mole fractions as shown in Table 5.1(b). Plotting the mole fraction values on the graph in
Figure 5.9 results in a straight line. The slope of the equilibrium line is approximately 1.0.<br>
(b) Convert the liquid and gas rates to lbmol/min:</p>

<img src="img/aw8.png"><br>

<img src="img/aw9.png">
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;=1.935</p>

<img src="img/aw10.png">
...
<div class="container">
   <a href="air_book1_lesson5.3.4.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson5.3.6.php" class="btn btn-primary">CONTINUE</a>
</div>
