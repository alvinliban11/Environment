...
<p>Calculate the gas molar flux (molar flow rate per unit cross section) and liquid
molar flux in lbmol/(ft2 . hr):
</p>


<img src="img/aw25.png"><br>

<img src="img/aw26.png"><br>
<img src="img/aw27.png">
...
<p><b>5.32 Packing Height for a Reactive Gas



</b></p>

<p>Determine the packing height of a packed countercurrent absorber required to
reduce the Cl2 concentration in a gas by 99% assuming that a dilute NaOH solution is employed. The following information is given:
</p>
<p class="indent">Liquid rate = 1000 lb/hr . ft2 (essentially water)
</p>
<p class="indent">Gas rate = 750 lb/hr . ft2 (essentially air)
</p>
<p class="indent">Mole fraction of Cl2 in inlet gas = 0.00043
</p>
<p class="indent">HOG = 1.63 ft
</p>
<p class="indent">(a) 1.63 ft
</p>
<p class="indent">(b) 3.75 ft
</p>
<p class="indent">(c) 7.50 ft
</p>
<p class="indent">(d) 8.71 ft
</p>
...
<img src="img/aw28.png"><br>
<img src="img/aw29.png">
...
<div class="container">
   <a href="air_book1_lesson5.3.9.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson5.3.11.php" class="btn btn-primary">CONTINUE</a>
</div>
