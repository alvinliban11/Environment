...
<p><b>3.7 Engineering Conversion Factors
</b></p>

<p >TGiven the following data for liquid methanol, determine its density in lb/ft3 and
convert heat capacity, thermal conductivity, and viscosity from the International
System of Units (SI) to English units:<br>
Specific gravity ¼ 0.92 (at 608F)<br>
Density of reference substance (water) ¼ 62.4 lb/ft3 (at 608F)<br>
Heat capacity ¼ 0.61 cal/g.8C) (at 608F)<br>
Thermal conductivity ¼ 0.0512 cal/m . s . 8C)<br>
Viscosity ¼ 0.64 cP (at 608F)<br>
Solution: As noted earlier, the definition of specific gravity for liquids and
solids is</p>

<img src="img/specific.png">


<p >Note that the density of water at 48C is 62.4 lb/ft3 in English engineering units or
1.0 g/cm3
.</p>
<p >Calculate the density of methanol in English units by multiplying the specific
gravity by the density of water:
</p>
<p>Density of methanol <br> = (specific gravity) (density of water)
<br> = (SG) (rref )
<br> = (0:92) (62:4Þ ¼ 57:4 lb=ft3
</p>
<p >The procedure is reversed if one is interested in calculating specific gravity from
density data. The notation for density is usually r.
...
<p >Note that 1.0 Btu/(lb.8F) is equivalent to 1.0 cal/(g.8C). This also applies on a
mole basis so that:</p>

<img src="img/btu.png">


<p>The usual notation for heat capacity is Cp. As noted earlier, Cp represents the heat
capacity on a mole basis, while cp will generally indicate a mass basis.
Now convert the thermal conductivity of methanol from cal/(m.s.8C) to
Btu/(ft.hr.8F):
</p>
...
<p>The usual engineering notation for thermal conductivity is k.
Finally, convert viscosity from centipoises to lb/(ft.s):
</p>
<img src="img/.64.png">



<p>The notation for viscosity is typically m. The kinematic viscosity n is defined by
the ratio of viscosity to density, i.e., n ¼ m/r with units of length2
/time. Also
note that this physical property is a strong function of the temperature but
weak function of the pressure. Interestingly, the viscosity of a gas increases
with increasing temperature, while the viscosity of a liquid decreases with an
...
<div class="container">
     <a href="air_book1_lesson3.6.1.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson3.6.3.php" class="btn btn-primary">CONTINUE</a>
</div>
