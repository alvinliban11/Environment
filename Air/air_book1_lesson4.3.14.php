...
<p><b>4.33 Gross Heating Value</b></p>

<p>Given the gas mixture and combustion properties listed in Table 4.3, determine
the gross heating value HVG in Btu/scf.<br>
Solution: The gross heating value (HVG) represents the enthalpy changes or heat
released when a gas is stoichiometrically combusted at 608F, with the final (flue)
products at 608F and any water present in the liquid state. Stoichiometric combustion requires that no oxygen be present in the flue gas following combustion</p>
<img src="img/ch38.png"><br>




<p>As noted in Section 4.2, the net heating value (HVN) is similar to HVG except the
water is in the vapor state. The net heating value is also known as the lower heating
value, and the gross heating value is also known as the higher heating value.</p>



<p><b>4.34 Natural Gas Requirement
</b></p>

<p>Determine the scfm of dry (at 608F, 1atm) natural gas (available heat at
14008F ¼ 950 Btu/scf) required to heat 8500 scfm of a contaminated gas
stream at 2008F to 14008F. Assume that there are no heat losses and that the
average heat capacity of the gas over the temperature range is 7.5 Btu/lb mol . 8F:<br>
(a) 120 scfm<br>
(b) 213 scfm<br>
(c) 1682 scfm<br>
(d) 3215 scfm<br>
Solution: The describing equation used to calculate the fuel rate: is given by</p>

<img src="img/ch39.png"><br>
...
<div class="container">
   <a href="air_book1_lesson4.3.13.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.3.15.php" class="btn btn-primary">CONTINUE</a>
</div>
