...
<p><b>5.1 Effect of Pressure on the Absorption Process
</b></p>

<img src="img/p1.png">

<p><b>5.2 Effect of Temperature on the Absorption Process
...
<p><b>5.3 Absorber Equipment</b></p>

<p>Which of the equipment listed below is generally not classified as an absorber?<br>
(a) Packed tower<br>
(b) Spray tower<br>
(c) Plate column<br>
(d) Indirect condenser<br>
Solution: As described in Section 5.1, packed towers, spray towers, and plate
columns are classified as absorbers. The correct answer is therefore (d).</p>

<p><b>5.4 Absorber Flow Classification
</b></p>

<p>The type of packed tower in which the average concentration gradient is maximized (the most dilute pollutant in the gas phase is contacted with the purest
liquid absorbent) is the<br>
(a) Concurrent<br>
(b) Countercurrent<br>
(c) Cross-current<br>
(d) Cyclonic<br>
Solution: During countercurrent flow, the most dilute pollutant is contacted with
the purest liquid absorbent at the top of the column. The net effect is to produce
the highest average concentration difference driving force across the entire length
of the column. The correct answer is therefore (b).</p>


<p><b>5.5 Henry’s Law Limitation
</b></p>

<p>Henry’s law applies if the equilibrium diagram of a system is a straight line. For
most systems, the equilibrium diagram is a straight line if<br>
(a) The solution is very concentrated<br>
(b) The solution is dilute<br>
(c) Water is the solute<br>
(d) The partial pressure of the absorbate is large<br>
Solution: For most systems, an equilibrium plot of y (or p) vs. x is concave mp
for higher values of x. It is linear at lower values. The correct answer is
therefore (b).</p>

<p><b>5.6 Effect of Heavy Inlet Particulate Load

</b></p>

<p>Which of the following absorbers would be the worst choice if the exhaust
stream contained a heavy particulate load?<br>
(a) Venturi<br>
(b) Spray tower<br>
(c) Cross-flow packed tower<br>
(d) Countercurrent packed tower<br>
Solution: A heavy particulate load would severely impact any absorber that contained packing. Therefore, only (c) and (d) are eligible answers. However, the
ability to retain the particulate is further enhanced with countercurrent flow,
i.e., the likelihood of washing out the particulates is reduced. The correct
answer is therefore (d).</p>


<p><b>5.7 Countercurrent Packed Tower/Spray Tower Comparison
</b></p>

<p>Countercurrent packed flow absorbers are more efficient than spray towers
because of the packed tower’s increased<br>
(a) Pressure drop used to collect the gases<br>
(b) Diameter<br>
(c) Tower height<br>
(d) Gas–liquid interfacial area<br>
Solution: Packing provides for more intimate mixing between the gas and liquid
phases, producing more interfacial area for control. The correct answer is
therefore (d).</p>
...
<div class="container">
   <a href="air_book1_lesson5.3.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson5.3.2.php" class="btn btn-primary">CONTINUE</a>
</div>
