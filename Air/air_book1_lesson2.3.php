...
<div class="dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <a class="dropdown-item" href="air_book1_lesson2.3.php" style=" border-left: 7px solid green;">Lesson 2.3</a>
...
<div class="container">
    <h2>LESSON 2.3:  LAWS AND REGULATIONS: THE DIFFERENCES</h2>



<p>The following (W. Matystik: private communications, 1995) are some of the major
differences between a federal law and a federal regulation, as briefly discussed in the
previous section. <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>

<p class="indent">1. A law (or Act) is passed by both houses of Congress and signed by the President.
A regulation is issued by a government agency such as the EPA or the
Occupational Safety and Health Administration (OSHA).</p>
<p class="indent">2. Congress can pass a law on any subject it chooses. It is limited only by the restrictions in the Constitution. A law can be challenged in court if it is unwise, unreasonable, or even silly. If, for example, a law was passed that placed a tax on
burping (belching), it could not be challenged in court just because it was unenforceable. A regulation can be issued by an agency only if the agency is authorized
...
OSHA is authorized by the Occupational Safety and Health Act to issue regulations that protect workers from exposure to the hazardous chemicals they use
...
The EPA is authorized to regulate such practices.)</p>
<p class="indent">3. Laws can include a Congressional mandate directing EPA to develop a comprehensive set of regulations. Regulations, or rulemakings, are issued by an agency,
such as EPA, that translates the general mandate of a statute into a set of
requirements for the Agency and the regulated community.</p>
<p class="indent">4. Regulations are developed by EPA in an open and public manner according to an
established process. When a regulation is formally proposed, it is published in an
official government document called the Federal Register to notify the public of
EPA’s intent to create new regulations or modify existing ones. EPA provides the
public, which includes the potentially regulated community, with an opportunity
to submit comments. Following an established comment period, EPA may revise
the proposed rule on the basis of both an internal review process and public
comments.</p>
<p class="indent">5. The final regulation is published, once promulgated, in the Federal Register.
Included with the regulation is a discussion of the Agency’s rationale for the regulatory approach, known as preamble language. Final regulations are compiled
annually and incorporated in the Code of Federal Regulations (CFR) according
to a highly structured format based on the topic(s) of the regulation. This latter
process is called codification, and each CFR title corresponds to a different regulatory authority. For example, EPA’s regulations are in Title 40 of the CFR. The
codified RCRA regulations can be found in Title 40 of the CFR, Parts 240–282.
These regulations are often cited as 40 CFR, with the part listed afterward (e.g., 40
CFR Part 264), or the part and section (e.g., 40 CFR §264.10).</p>
<p class="indent">6. A regulation may be challenged in court because the issuing agency exceeded
the mandate given it by Congress. If the law requires the agency to consider
costs versus benefits of the regulation, the regulation could be challenged in
court if the cost/benefit analysis were not correctly or adequately done. If
OSHA issues a regulation limiting a worker’s exposure to a hazardous chemical
to 1 part per million (ppm), OSHA could be called on to prove in court that such
a low limit was needed to prevent a worker from being harmed. Failure to prove
this would mean that OSHA exceeded its mandate under the law, as OSHA is
charged to develop standards only as stringent as those required to protect
worker health and provide worker safety.</p>
<p class="indent">7. Laws are usually brief and general. Regulations are usually lengthy and detailed.
The Hazardous Materials Transportation Act, for example, is only approximately
20 pages long. It speaks in general terms about the need to protect the public
from the dangers associated with transporting hazardous chemicals and identifies
the Department of Transportation (DOT) as the agency responsible for issuing
regulations implementing the law. The regulations issued by the DOT are
several thousand pages long and are very detailed down to the exact size,
shape, design, and color of the warning placards that must be used on trucks
carrying any of the thousands of regulated chemicals.</p>
<p class="indent">8. Generally, laws are passed infrequently. Often years pass between amendments
to an existing law. A completely new law on a given subject already addressed by
an existing law is unusual. Laws are published as a “Public Law— - —” and are
eventually codified into the United States Code.</p>
<p class="indent">9. Regulations are issued and amended frequently. Proposed and final new regulations and amendments to existing regulations are published daily in the
Federal Register. Final regulations have the force of law when published.</p>
...
<div class="container">
    <span class="text-success">Completed</span>
         <a href="air_book1_lesson2.2.php" class="btn btn-danger form-inline">BACK</a>   

    <a href="air_book1_lesson2.4.php" class="btn btn-primary">CONTINUE TO LESSON 2</a>
</div>
