...
<p><b>4.29 Ethylene Oxidation
</b></p>




<p>Ethylene oxide is produced by the oxidation of ethylene with oxygen-enriched
air:</p>
<img src="img/ch29.png"><br>




<p>The feed stream to an ethylene oxide reactor consists of 45% (by mole) C2H4,
30% O2, and 25% N2. The amounts of ethylene oxide and carbon dioxide in
the product stream are 20gmol and 10gmol, respectively, per 100 gmol feed.
Determine the composition of the exiting gas stream.<br>
Solution: Selecting a basis of 100 gmol feed stream, a flow diagram of the
process may be generated as shown in Figure 4.7. One may apply extent of reaction balances to determine expressions for each of the components leaving the
reactor in terms of the amount of C2H4 converted to C2H4O and the amount
converted to CO2:</p>
<img src="img/ch30.png"><br>
<img src="img/ch31.png">
...
<div class="container">
   <a href="air_book1_lesson4.3.10.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.3.12.php" class="btn btn-primary">CONTINUE</a>
</div>
