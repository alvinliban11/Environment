...
<p><b>5.24 Column Mole Balance
</b></p>

<p>Given the following information for a packed countercurrent gas scrubber, determine the liquid flow rate in lbmol/hr . ft2.
</p>
<p>Gas flow rate = 18lbmol/hr . ft2<br>
The mole fractions of pollutant in inlet and outlet gas are 0.08 and 0.002,
respectively<br>
The mole fractions of pollutant in inlet and outlet liquid are 0.001 and 0.05,
respectively.<br>
(a) 28.7<br>
(b) 36.0<br>
(c) 40.0<br>
(d) 57.3<br>
Solution: Applying a componential mole balance (dropping the subscripts) on
the pollutant gives
</p>

<img src="img/aw11.png">

<p><b>5.25 Liquid Requirement
</b></p>

<p>The EPA has conducted investigations on the exhaust streams from Valco
Chemical Company. To Valco’s dismay, their hydrocarbon emissions are too
high and must be reduced in order to continue operation. At present conditions,
the exhaust stream contains 1.0% benzene at a total flow of 40,000 ft3
/hr. It has
been determined that if the exhaust stream is brought down to 0.01% benzene,
the company can continue operation. An absorber that is currently out of
commission will be used to absorb the benzene, employing a light wash oil as
the absorbent. The pump on the liquid feed has a maximum liquid pumping
rate of 50 ft3
/hr. Does this pump have enough capacity to do the job if the
outlet benzene concentration in the wash oil cannot exceed 5.0%? Operating
data are provided below:</p>

<p class="indent">Gas temperature = 1008F<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Liquid temperature = 608F<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Light oil molecular weight (MW) = 156 lb/lbmol<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Light oil density = 55.1lb/ft3<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Actual liquid flow rate = (1.5)Lm,min</p>

<img src="img/aw12.png">

<p>The pump will therefore not do the job! Finally, the reader should consider
whether there is another way to perform the calculation.</p>
...
<div class="container">
   <a href="air_book1_lesson5.3.5.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson5.3.7.php" class="btn btn-primary">CONTINUE</a>
</div>
