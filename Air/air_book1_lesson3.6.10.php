...
<p><b>3.28 Compliance Determination</b></p>

<p>A proposed incinerator is designed to destroy a hazardous waste at 21008F
and 1atm. Current regulations dictate that a minimum destruction and removal
...
Is the unit in compliance?<br>
Solution: Select as a basis the 1 hourly rate of operation. The mass equation
employed for efficiency may also be used to calculate the minimum destruction
and removal efficiency.</p>

<img src="img/dre.png">


<p>Thus the unit is operating in compliance with present regulations. The answer
is yes.</p>

<p><b>3.29 Velocity Determination
</b></p>

<p>Given 20,000 ft3
/min of air at ambient conditions exiting a system through
a pipe whose cross-sectional area is 4 ft2
, determine the mass flow rate in
lb/min and the exit velocity in ft/s.<br>
Solution: The continuity equation is given by</p>

<img src="img/psv.png">



<p><b>3.30 Outlet Temperature
</b></p>

<p>Heat at 18.7  106 Btu/hr is transferred from the flue gas of an incinerator.
Calculate the outlet temperature of the gas stream using the following
information:</p>

<img src="img/average.png">

<p>Solution: The first law of thermodynamics states that energy is conserved. For a
flow system, neglecting kinetic and potential effects, the energy transferred Q to
or from the flowing medium is given by the enthalpy change DH of the medium.
...
alone. Changes in enthalpy resulting from a temperature change for a singlephase material may be calculated from the equation</p>
...
<div class="container">
    <a href="air_book1_lesson3.6.9.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson3.6.11.php" class="btn btn-primary">CONTINUE</a>
</div>
