...
<p><b>4.42 First-order Kinetics



</b></p>

<p>In order to meet recently updated pollution regulations for discharging hydrocarbons to the atmosphere, a gas stream must be reduced by 99.5% of its present
hydrocarbon concentration. Owing to economic considerations, it is proposed
to meet this requirement by combusting the hydrocarbons in a tubular thermal oxidizer operating at 15008F. The gas and methane (fuel) are to be fed to the reactor at
80F and 1 atm. Design the proposed oxidizer using kinetic principles.
</p>


<p>Data<br>
Flue gas flow rate (from fuel combustion) = 2500 scfm (808F, 1atm)<br>
Process gas flow rate = 7200 scfm<br>
Hydrocarbon: essentially toluene<br>
Reaction rate constant, k = 7.80s21 at 15008F<br>
Average velocity = 20ft/s;<br>
C1/C0 = 0.005/1.0<br>
C1 and C0 are the final and initial concentrations, respectively.<br>
Solution: In terms of the actual operating conditions of the oxidizer, the volumetric flow rate is (applying Charles’ Law)</p>




<img src="img/ch61.png">

<p>Calculate the residence time required assuming first-order kinetics (see J.
Reynolds, J. Jeris, and L. Theodore, Handbook of Chemical and
Environmental Engineering Calculations, John Wiley & Sons, Hoboken, NJ,
2004 for additional details) in a plug flow oxidizer.</p>

<img src="img/ch62.png">
...
<div class="container">
   <a href="air_book1_lesson4.3.21.php" class="btn btn-danger form-inline">BACK</a>
    <a href="air_book1_lesson4.3.23.php" class="btn btn-primary">CONTINUE</a>
</div>
